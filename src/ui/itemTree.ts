...
import { getItemStatus, removeAllStatuses, getStatusFromTag, getItemStatusTags, generateMenuIcon, getAllReasonsFromItems } from "../utils/helpers"
...
export class ReviewModule {
    ...
    static registerExtraColumnWithBindings() {
        ...
        const statusMenuChildren = allStatuses.map((status: Status): MenuitemOptions => {
        ...
        ztoolkit.getGlobal("document").setStatusReason = async (selectedItems) => {
            ...
            const inputReason = document.reasonModal.element.querySelector("#input-reason") as HTMLInputElement
            inputReason.value = ""
