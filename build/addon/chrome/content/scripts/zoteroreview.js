...
(() => {
    ...
    if ((e && typeof e == "object") || typeof e == "function")
      for (let n of Zo(e))
        !Go.call(r, n) &&
          ...
          kr(r, n, {
            get: () => e[n],
            enumerable: !(i = cn(e, n)) || i.enumerable,
          });
    return r;
  };
  var Ce = (r, e, t) => (
    ...
    Wo(
      e || !r || !r.__esModule
        ? kr(t, "default", { value: r, enumerable: !0 })
        : t,
      r,
    )
  );
  var ft = (r, e, t, i) => {
    for (
      var n = i > 1 ? void 0 : i ? cn(e, t) : e, s = r.length - 1, o;
      s >= 0;
      s--
    )
  ...
  var un = v((Le) => {
    ...
    var wr = x(),
      ...
      Qe = class r {
        ...
        get password() {
          return wr.BasicTool.getZotero().Prefs.get(r.passwordPref, !0);
        }
        set password(e) {
          wr.BasicTool.getZotero().Prefs.set(r.passwordPref, e, !0);
        }
        constructor() {
        ...
        initializeDebugBridge() {
          let e = {
            ...
            doAction: async (t) => {
              ...
              let c =
                  Uo.default.getInstance().debugBridge
...
If you do not know what it is, please click Cancel to deny.`))
    ...
    Le.DebugBridge = Qe;
    Qe.version = 2;
    Qe.passwordPref = "extensions.zotero.debug-bridge.password";
  });
  var hn = v((gt) => {
    "use strict";
    Object.defineProperty(gt, "__esModule", { value: !0 });
    gt.PluginBridge = void 0;
    var Jo = x(),
      mt = class r {
        get version() {
          return r.version;
                ...
                try {
                  ...
                  if (
                    ...
                    if (c && c.state === e.STATE_AVAILABLE)
                      c.install(), dn("Plugin installed successfully.", !0);
                    else throw new Error(`Plugin ${a.url} is not available.`);
                  }
                } catch (o) {
                  t.logError(o), dn(o.message, !1);
                }
              },
  ...
  var ae = v(($e) => {
    ...
    var xr = x(),
      ...
      bt = class r {
        constructor() {
          pn(this),
            (this.currentWindow = xr.BasicTool.getZotero().getMainWindow());
        }
        static getInstance() {
          let e = xr.BasicTool.getZotero(),
            t = !1;
          "_toolkitGlobal" in e || ((e._toolkitGlobal = new r()), (t = !0));
          let i = e._toolkitGlobal;
          return (
            i.currentWindow !== e.getMainWindow() && (Xo(i), (t = !0)),
            t && pn(i),
            i
          );
        }
    ...
    function pn(r) {
      Pe(r, "fieldHooks", {
        ...
        Qo.DebugBridge.setModule(r),
        $o.PluginBridge.setModule(r);
    }
    function Pe(r, e, t) {
      var i, n;
      if (t) {
    ...
    function Xo(r) {
      (r.currentWindow = xr.BasicTool.getZotero().getMainWindow()),
        (r.itemTree = void 0),
        (r.itemBox = void 0),
        (r.shortcut = void 0),
        (r.prompt = void 0),
        ...
        constructor(e) {
          (this.patchSign = "zotero-plugin-toolkit@2.0.0"),
            (this._basicOptions = {
              ...
              debug: ea.default.getInstance().debugBridge,
...
`),
    ...
    function ta(r) {
      Object.values(r).forEach((e) => {
        (e instanceof vt || typeof e?.unregisterAll == "function") &&
          e.unregisterAll();
      });
    }
    K.unregister = ta;
    function ra(r, e) {
      return new Proxy(r, {
        construct(t, i) {
          let n = new r(...i);
          return n instanceof Xe && n.updateOptions(e), n;
        },
      });
    }
    K.makeHelperTool = ra;
  ...
  var q = v((B) => {
    ...
    B.extend = yn;
    B.indexOf = la;
    B.escapeExpression = ca;
    B.isEmpty = ua;
    B.createFrame = da;
    B.blockParams = ha;
    B.appendContextPath = pa;
    var na = {
        "&": "&amp;",
        "<": "&lt;",
        ">": "&gt;",
    ...
    Pr(/x/) &&
      (B.isFunction = Pr =
        function (r) {
          return typeof r == "function" && Tr.call(r) === "[object Function]";
        });
    B.isFunction = Pr;
    var _n =
      Array.isArray ||
      function (r) {
        return r && typeof r == "object" ? Tr.call(r) === "[object Array]" : !1;
      };
    B.isArray = _n;
    function la(r, e) {
    ...
    function ca(r) {
      ...
      return oa.test(r) ? r.replace(sa, aa) : r;
    }
    function ua(r) {
      return !r && r !== 0 ? !0 : !!(_n(r) && r.length === 0);
    }
    function da(r) {
      var e = yn({}, r);
      ...
      r.registerHelper("blockHelperMissing", function (e, t) {
        ...
        if (Ar.isArray(e))
          return e.length > 0
            ...
            : i(this);
        if (t.data && t.ids) {
          var s = Ar.createFrame(t.data);
          (s.contextPath = Ar.appendContextPath(t.data.contextPath, t.name)),
            (t = { data: s });
        }
        return n(e, t);
      });
    };
    wn.exports = xt.default;
  });
  var Cn = v((St, Sn) => {
    "use strict";
    St.__esModule = !0;
    ...
    var Ye = q(),
      ma = G(),
      ga = fa(ma);
    St.default = function (r) {
      r.registerHelper("each", function (e, t) {
        if (!t) throw new ga.default("Must pass iterator to #each");
        var i = t.fn,
          n = t.inverse,
          s = 0,
          o = "",
        ...
        t.data &&
          t.ids &&
          (c = Ye.appendContextPath(t.data.contextPath, t.ids[0]) + "."),
          Ye.isFunction(e) && (e = e.call(this)),
          t.data && (a = Ye.createFrame(t.data));
        function l(p, g, b) {
          a &&
            ((a.key = p),
            (a.index = g),
            ...
            (o =
              ...
              i(e[p], {
                data: a,
                blockParams: Ye.blockParams([e[p], p], [c + p, null]),
              }));
        }
    ...
    Ct.default = function (r) {
      r.registerHelper("helperMissing", function () {
        if (arguments.length !== 1)
          throw new ya.default(
            'Missing helper: "' + arguments[arguments.length - 1].name + '"',
          );
      });
    };
    Ln.exports = Ct.default;
  });
  var An = v((Lt, En) => {
    "use strict";
    Lt.__esModule = !0;
    ...
    Lt.default = function (r) {
      r.registerHelper("if", function (e, t) {
        if (arguments.length != 2)
          throw new In.default("#if requires exactly one argument");
        return (
          Tn.isFunction(e) && (e = e.call(this)),
          (!t.hash.includeZero && !e) || Tn.isEmpty(e)
            ? t.inverse(this)
            : t.fn(this)
        );
      }),
        r.registerHelper("unless", function (e, t) {
          if (arguments.length != 2)
            throw new In.default("#unless requires exactly one argument");
  ...
  var Hn = v((It, qn) => {
    ...
    It.default = function (r) {
      r.registerHelper("with", function (e, t) {
        if (arguments.length != 2)
          throw new Sa.default("#with requires exactly one argument");
        et.isFunction(e) && (e = e.call(this));
        var i = t.fn;
        if (et.isEmpty(e)) return t.inverse(this);
        var n = t.data;
        return (
          t.data &&
            t.ids &&
            ((n = et.createFrame(t.data)),
            (n.contextPath = et.appendContextPath(
              t.data.contextPath,
              t.ids[0],
            ))),
          i(e, {
            data: n,
            blockParams: et.blockParams([e], [n && n.contextPath]),
          })
        );
      });
    };
    qn.exports = It.default;
  });
  var Mr = v((Et) => {
    "use strict";
    Et.__esModule = !0;
    Et.registerDefaultHelpers = za;
    Et.moveHelperToHooks = Fa;
    function ge(r) {
      return r && r.__esModule ? r : { default: r };
    }
    var Ca = xn(),
  ...
  var zn = v((At, Bn) => {
      ...
      r.registerDecorator("inline", function (e, t, i, n) {
        ...
        return (
          t.partials ||
            ...
            (s = function (o, a) {
              var c = i.partials;
              i.partials = Va.extend({}, c, t.partials);
              var l = e(o, a);
    ...
    Bn.exports = At.default;
  });
  var Fn = v((Rr) => {
    "use strict";
    Rr.__esModule = !0;
    Rr.registerDefaultDecorators = Ga;
    function Da(r) {
      return r && r.__esModule ? r : { default: r };
    }
    var Za = zn(),
  ...
  var Nr = v((Mt, Vn) => {
    ...
    var Wa = q(),
      Ee = {
        ...
        lookupLevel: function (e) {
          if (typeof e == "string") {
            var t = Wa.indexOf(Ee.methodMap, e.toLowerCase());
        ...
        log: function (e) {
          if (
            ((e = Ee.lookupLevel(e)),
            typeof console < "u" && Ee.lookupLevel(Ee.level) <= e)
          ) {
            var t = Ee.methodMap[e];
            console[t] || (t = "log");
            for (
    ...
    Mt.default = Ee;
    Vn.exports = Mt.default;
  });
  var Dn = v((Or) => {
    "use strict";
    Or.__esModule = !0;
    Or.createNewLookupObject = Ua;
    var ja = q();
    function Ua() {
      for (var r = arguments.length, e = Array(r), t = 0; t < r; t++)
        e[t] = arguments[t];
      return ja.extend.apply(void 0, [Object.create(null)].concat(e));
    }
  });
  var qr = v((tt) => {
    "use strict";
    tt.__esModule = !0;
    tt.createProtoAccessControl = Xa;
    tt.resultIsAllowed = Ya;
    tt.resetLoggedProperties = tl;
    function Ja(r) {
      return r && r.__esModule ? r : { default: r };
    }
    var Zn = Dn(),
    ...
    function Xa(r) {
      ...
      return (
        ...
        {
          properties: {
            whitelist: Zn.createNewLookupObject(t, r.allowedProtoProperties),
            defaultValue: r.allowProtoPropertiesByDefault,
          },
          methods: {
            whitelist: Zn.createNewLookupObject(e, r.allowedProtoMethods),
    ...
    function Ya(r, e, t) {
      return Kn(typeof r == "function" ? e.methods : e.properties, t);
    }
    function Kn(r, e) {
...
See https://handlebarsjs.com/api-reference/runtime-options.html#options-to-control-prototype-access for details`,
  ...
  var Ot = v((Q) => {
    ...
    Q.VERSION = al;
    var ll = 8;
    Q.COMPILER_REVISION = ll;
    var cl = 7;
    Q.LAST_COMPATIBLE_COMPILER_REVISION = cl;
    var ul = {
      1: "<= 1.0.rc.2",
      2: "== 1.0.0-rc.3",
      3: "== 1.0.0-rc.4",
    ...
    Q.REVISION_CHANGES = ul;
    var Br = "[object Object]";
    function zr(r, e, t) {
      (this.helpers = r || {}),
        (this.partials = e || {}),
        (this.decorators = t || {}),
        il.registerDefaultHelpers(this),
        nl.registerDefaultDecorators(this);
    }
    zr.prototype = {
      constructor: zr,
      logger: Nt.default,
      ...
      registerPartial: function (e, t) {
        if (be.toString.call(e) === Br) be.extend(this.partials, e);
        else {
          if (typeof t > "u")
            throw new Hr.default(
      ...
      resetLoggedPropertyAccesses: function () {
        ol.resetLoggedProperties();
      },
    };
    var dl = Nt.default.log;
    Q.log = dl;
  ...
  var jn = v((qt, Wn) => {
    ...
    Fr.prototype.toString = Fr.prototype.toHTML = function () {
      return "" + this.string;
    };
    qt.default = Fr;
    Wn.exports = qt.default;
  });
  var Un = v((Vr) => {
    "use strict";
    Vr.__esModule = !0;
  ...
  var Yn = v((ce) => {
    ...
    function vl(r) {
      var e = (r && r[0]) || 1,
        t = re.COMPILER_REVISION;
      if (
        !(
          e >= re.LAST_COMPATIBLE_COMPILER_REVISION && e <= re.COMPILER_REVISION
        )
      )
        if (e < re.LAST_COMPATIBLE_COMPILER_REVISION) {
          var i = re.REVISION_CHANGES[t],
            n = re.REVISION_CHANGES[e];
    ...
    function yl(r, e) {
      if (!e) throw new te.default("No environment passed to template");
      if (!r || !r.main)
        throw new te.default("Unknown template object: " + typeof r);
      (r.main.decorator = r.main_d), e.VM.checkRevision(r.compiler);
      var t = r.compiler && r.compiler[0] === 7;
      function i(o, a, c) {
        c.hash && ((a = ee.extend({}, a, c.hash)), c.ids && (c.ids[0] = !0)),
...
`);
      ...
      var n = {
        strict: function (a, c, l) {
          if (!a || !(c in a))
            throw new te.default('"' + c + '" not defined in ' + a, { loc: l });
        ...
        lookupProperty: function (a, c) {
          ...
          if (
            ...
            Qn.resultIsAllowed(l, n.protoAccessControl, c)
          )
            return l;
        },
        lookup: function (a, c) {
        ...
        program: function (a, c, l, d, u) {
          ...
          return (
            c || u || d || l
              ? (h = Ht(this, a, f, c, l, d, u))
              : h || (h = this.programs[a] = Ht(this, a, f)),
            h
          );
        },
        data: function (a, c) {
        ...
        mergeIfNeeded: function (a, c) {
          var l = a || c;
          return a && c && a !== c && (l = ee.extend({}, c, a)), l;
        },
      ...
      function s(o) {
        var a =
            arguments.length <= 1 || arguments[1] === void 0
              ...
              : arguments[1],
          c = a.data;
        s._setup(a), !a.partial && r.useData && (c = wl(o, c));
        var l = void 0,
        ...
        return (u = Xn(r.main, u, n, a.depths || [], c, d)), u(o, a);
      }
      return (
        (s.isTop = !0),
        (s._setup = function (o) {
          if (o.partial)
            ...
            var a = ee.extend({}, e.helpers, o.helpers);
            xl(a, n),
              (n.helpers = a),
              r.usePartial &&
                (n.partials = n.mergeIfNeeded(o.partials, e.partials)),
              (r.usePartial || r.useDecorators) &&
                (n.decorators = ee.extend({}, e.decorators, o.decorators)),
              (n.hooks = {}),
              (n.protoAccessControl = Qn.createProtoAccessControl(o));
        ...
        (s._child = function (o, a, c, l) {
          if (r.useBlockParams && !c)
            throw new te.default("must pass block params");
          if (r.useDepths && !l)
            throw new te.default("must pass parent depths");
          return Ht(n, o, r[o], a, 0, c, l);
        }),
        s
      );
    }
    function Ht(r, e, t, i, n, s, o) {
      function a(c) {
        var l =
            arguments.length <= 1 || arguments[1] === void 0
              ? {}
              ...
              function (a) {
                var c =
                  arguments.length <= 1 || arguments[1] === void 0
                    ...
                    : arguments[1];
                return (
                  (c.data = re.createFrame(c.data)),
                  (c.data["partial-block"] = i),
                  s(a, c)
                );
              }),
              s.partials &&
                (t.partials = ee.extend({}, t.partials, s.partials));
          })(),
        r === void 0 && n && (r = n),
        r === void 0)
      )
        throw new te.default("The partial " + t.name + " could not be found");
    ...
    function Xn(r, e, t, i, n, s) {
      if (r.decorator) {
        var o = {};
        (e = r.decorator(e, o, t, i && i[0], n, s, i)), ee.extend(e, o);
      }
      return e;
    }
    function xl(r, e) {
    ...
    function Sl(r, e) {
      ...
      return bl.wrapHelper(r, function (i) {
        return ee.extend({ lookupProperty: t }, i);
      });
    }
  });
  var Dr = v((Bt, es) => {
  ...
  var ss = v((zt, ns) => {
    ...
    var Cl = Ot(),
      ...
      Rl = Kr(Ml);
    function is() {
      var r = new ts.HandlebarsEnvironment();
      return (
        Zr.extend(r, ts),
        (r.SafeString = Pl.default),
        (r.Exception = Il.default),
        (r.Utils = Zr),
        (r.escapeExpression = Zr.escapeExpression),
        (r.VM = rs),
        (r.template = function (e) {
          return rs.template(e, r);
        }),
        r
      );
    }
  ...
  var Wr = v((Ft, as) => {
    ...
    var os = {
      helpers: {
        ...
        simpleId: function (e) {
          return e.parts.length === 1 && !os.helpers.scopedId(e) && !e.depth;
        },
      },
    };
    Ft.default = os;
    as.exports = Ft.default;
  });
  var cs = v((Vt, ls) => {
    "use strict";
    Vt.__esModule = !0;
    var Nl = (function () {
      var r = {
          ...
          parse: function (n) {
            ...
            for (var C, F, L, S, pe, Y, oe = {}, fe, V, Ue, me; ; ) {
              if (
                ((L = o[o.length - 1]),
                this.defaultActions[L]
                  ? (S = this.defaultActions[L])
              ...
              switch (S[0]) {
                ...
                case 2:
                  if (
                    ...
                    (oe.$ = a[a.length - V]),
                    (oe._$ = {
                      first_line: c[c.length - (V || 1)].first_line,
                      last_line: c[c.length - 1].last_line,
                      first_column: c[c.length - (V || 1)].first_column,
                      last_column: c[c.length - 1].last_column,
                    }),
                    m &&
                      (oe._$.range = [
                        c[c.length - (V || 1)].range[0],
                  ...
                  V &&
                    ...
                    (a = a.slice(0, -1 * V)),
                    (c = c.slice(0, -1 * V))),
                    o.push(this.productions_[S[1]][0]),
                    a.push(oe.$),
                    c.push(oe._$),
                    (Ue = l[o[o.length - 2]][o[o.length - 1]]),
                    o.push(Ue);
                  break;
                case 3:
                  return !0;
...
` +
  ...
  var Ur = v((Kt, hs) => {
    ...
    Dt.prototype = {
      ...
      PartialBlockStatement: function (e) {
        ds.call(this, e), this.acceptKey(e, "program");
      },
      ...
      for (var i = r.body, n = 0, s = i.length; n < s; n++) {
        ...
        if (a) {
          ...
          a.close && ve(i, n, !0),
            ...
            e && d && (ve((o.program || o.inverse).body), ue(i, n)),
            e && u && (ve(i, n), ue((o.inverse || o.program).body));
        }
      }
      return r;
    };
      ...
      $.prototype.PartialBlockStatement =
        function (r) {
          ...
          var s = {
            ...
            openStandalone: Qr(e.body),
            closeStandalone: Jr((i || e).body),
          };
          if ((r.openStrip.close && ve(e.body, null, !0), t)) {
            var o = r.inverseStrip;
            o.open && ue(e.body, null, !0),
              o.close && ve(i.body, null, !0),
              r.closeStrip.open && ue(n.body, null, !0),
              !this.options.ignoreStandalone &&
                Jr(e.body) &&
                Qr(i.body) &&
                (ue(e.body), ve(i.body));
          } else r.closeStrip.open && ue(e.body, null, !0);
          return s;
        };
  ...
  var ms = v((W) => {
    ...
    W.stripComment = Gl;
    W.preparePath = Wl;
    W.prepareMustache = jl;
    W.prepareRawBlock = Ul;
    W.prepareBlock = Jl;
    W.prepareProgram = Ql;
    W.preparePartialBlock = $l;
    function Fl(r) {
      return r && r.__esModule ? r : { default: r };
    }
    var Vl = G(),
    ...
    function Xr(r, e) {
      if (((e = e.path ? e.path.original : e), r.path.original !== e)) {
        ...
        throw new $r.default(r.path.original + " doesn't match " + e, t);
      }
    }
    function Dl(r, e) {
      (this.source = r),
    ...
    function Wl(r, e, t) {
      ...
      for (
        ...
        if (
          ...
          if (n.length > 0)
            throw new $r.default("Invalid path: " + i, { loc: t });
          c === ".." && s++;
        } else n.push(c);
      }
      return {
    ...
    function Jl(r, e, t, i, n, s) {
      ...
      var a = void 0,
        c = void 0;
      if (t) {
        if (o) throw new $r.default("Unexpected inverse block on decorator", t);
  ...
  var vs = v((it) => {
    ...
    var Yl = cs(),
      ...
      ic = Xl(rc),
      nc = q();
    it.parser = Yr.default;
    var Wt = {};
    nc.extend(Wt, ic);
    function bs(r, e) {
      if (r.type === "Program") return r;
      (Yr.default.yy = Wt),
        (Wt.locInfo = function (i) {
          return new Wt.SourceLocation(e && e.srcName, i);
        });
      var t = Yr.default.parse(r);
      return t;
    }
    function sc(r, e) {
      var t = bs(r, e),
  ...
  var ws = v((at) => {
    ...
    ei.prototype = {
      ...
      equals: function (e) {
        ...
        for (var i = 0; i < t; i++) {
          var n = this.opcodes[i],
            s = e.opcodes[i];
          if (n.opcode !== s.opcode || !ks(n.args, s.args)) return !1;
        }
      ...
      accept: function (e) {
        if (!this[e.type]) throw new st.default("Unknown type: " + e.type, e);
      ...
      PathExpression: function (e) {
        ...
        var t = e.parts[0],
          i = nt.default.helpers.scopedId(e),
      ...
      classifySexpr: function (e) {
        var t = nt.default.helpers.simpleId(e.path),
          i = t && !!this.blockParamIndex(e.path.parts[0]),
          n = !i && nt.default.helpers.helperExpression(e),
          s = !i && (n || t);
        if (s && !n) {
    ...
    function ks(r, e) {
      if (r === e) return !0;
      if (ot.isArray(r) && ot.isArray(e) && r.length === e.length) {
        for (var t = 0; t < r.length; t++) if (!ks(r[t], e[t])) return !1;
        return !0;
      }
    }
    function ys(r) {
  ...
  var Ss = v((ti) => {
    ...
    ti.encode = function (r) {
      if (0 <= r && r < xs.length) return xs[r];
      throw new TypeError("Must be between 0 and 63: " + r);
    };
    ti.decode = function (r) {
      var e = 65,
        t = 90,
        i = 97,
        n = 122,
  ...
  var ni = v((ii) => {
    ...
    ii.encode = function (e) {
      var t = "",
        i,
        n = dc(e);
      do (i = n & Ps), (n >>>= ri), n > 0 && (i |= Ts), (t += Cs.encode(i));
      while (n > 0);
      return t;
    };
    ii.decode = function (e, t, i) {
      var n = e.length,
        s = 0,
        o = 0,
        a,
      ...
      do {
        ...
        if (((c = Cs.decode(e.charCodeAt(t++))), c === -1))
          throw new Error("Invalid base64 digit: " + e.charAt(t - 1));
        (a = !!(c & Ts)), (c &= Ps), (s = s + (c << o)), (o += ri);
      } while (a);
      (i.value = hc(s)), (i.rest = t);
    };
  });
  var Re = v((N) => {
    function pc(r, e, t) {
    ...
    function si(r) {
      ...
      for (
        var i = N.isAbsolute(e), n = e.split(/\/+/), s, o = 0, a = n.length - 1;
        a >= 0;
        a--
      )
        (s = n[a]),
    ...
    function Es(r, e) {
      ...
      if ((i && (r = i.path || "/"), t && !t.scheme))
        return i && (t.scheme = i.scheme), Ae(t);
      if (t || e.match(fc)) return e;
      if (i && !i.host && !i.path) return (i.host = e), Ae(i);
      var n = e.charAt(0) === "/" ? e : si(r.replace(/\/+$/, "") + "/" + e);
      return i ? ((i.path = n), Ae(i)) : n;
    }
    N.join = Es;
    N.isAbsolute = function (r) {
      return r.charAt(0) === "/" || Is.test(r);
    };
    function mc(r, e) {
      r === "" && (r = "."), (r = r.replace(/\/$/, ""));
    ...
    N.toSetString = As ? Ms : gc;
    function bc(r) {
      return Rs(r) ? r.slice(1) : r;
    }
    N.fromSetString = As ? Ms : bc;
    function Rs(r) {
      if (!r) return !1;
      var e = r.length;
      if (
  ...
  var li = v((Ns) => {
    ...
    ie.fromArray = function (e, t) {
      for (var i = new ie(), n = 0, s = e.length; n < s; n++) i.add(e[n], t);
      return i;
    };
    ...
    ie.prototype.add = function (e, t) {
      var i = ye ? e : oi.toSetString(e),
        n = ye ? this.has(e) : ai.call(this._set, i),
        s = this._array.length;
      (!n || t) && this._array.push(e),
        n || (ye ? this._set.set(e, s) : (this._set[i] = s));
    };
    ie.prototype.has = function (e) {
      if (ye) return this._set.has(e);
      var t = oi.toSetString(e);
      return ai.call(this._set, t);
    };
    ie.prototype.indexOf = function (e) {
      if (ye) {
        ...
        var i = oi.toSetString(e);
        if (ai.call(this._set, i)) return this._set[i];
      }
  ...
  var Hs = v((qs) => {
    ...
    function xc(r, e) {
      ...
      return (
        i > t ||
        (i == t && s >= n) ||
        Os.compareByGeneratedPositionsInflated(r, e) <= 0
      );
    }
    function jt() {
      (this._array = []),
    ...
    jt.prototype.toArray = function () {
      return (
        this._sorted ||
          (this._array.sort(Os.compareByGeneratedPositionsInflated),
          (this._sorted = !0)),
        this._array
      );
    };
  ...
  var ci = v((Bs) => {
    ...
    function j(r) {
      r || (r = {}),
        (this._file = E.getArg(r, "file", null)),
        (this._sourceRoot = E.getArg(r, "sourceRoot", null)),
        (this._skipValidation = E.getArg(r, "skipValidation", !1)),
        (this._sources = new Ut()),
        (this._names = new Ut()),
        (this._mappings = new Sc()),
        (this._sourcesContents = null);
    }
    j.prototype._version = 3;
    j.fromSourceMap = function (e) {
      var t = e.sourceRoot,
        i = new j({ file: e.file, sourceRoot: t });
      return (
        e.eachMapping(function (n) {
          ...
          n.source != null &&
            ((s.source = n.source),
            t != null && (s.source = E.relative(t, s.source)),
    ...
    j.prototype.addMapping = function (e) {
      var t = E.getArg(e, "generated"),
        i = E.getArg(e, "original", null),
        n = E.getArg(e, "source", null),
        s = E.getArg(e, "name", null);
    ...
    j.prototype.setSourceContent = function (e, t) {
      var i = e;
      this._sourceRoot != null && (i = E.relative(this._sourceRoot, i)),
        t != null
          ? (this._sourcesContents ||
              (this._sourcesContents = Object.create(null)),
            (this._sourcesContents[E.toSetString(i)] = t))
          : this._sourcesContents &&
            (delete this._sourcesContents[E.toSetString(i)],
            Object.keys(this._sourcesContents).length === 0 &&
              (this._sourcesContents = null));
    };
    j.prototype.applySourceMap = function (e, t, i) {
      var n = t;
      if (t == null) {
        if (e.file == null)
          throw new Error(
      ...
      this._mappings.unsortedForEach(function (c) {
        if (c.source === n && c.originalLine != null) {
          ...
          l.source != null &&
            ((c.source = l.source),
            i != null && (c.source = E.join(i, c.source)),
            s != null && (c.source = E.relative(s, c.source)),
        ...
        e.sources.forEach(function (c) {
          ...
          l != null &&
            (i != null && (c = E.join(i, c)),
            s != null && (c = E.relative(s, c)),
            this.setSourceContent(c, l));
        }, this);
    };
    j.prototype._validateMapping = function (e, t, i, n) {
    ...
    j.prototype._serializeMappings = function () {
      for (
        var e = 0,
          t = 1,
          i = 0,
        ...
        if (((l = h[f]), (c = ""), l.generatedLine !== t))
          ...
          if (!E.compareByGeneratedPositionsInflated(l, h[f - 1])) continue;
          c += ",";
        }
        (c += ct.encode(l.generatedColumn - e)),
          (e = l.generatedColumn),
          l.source != null &&
            ((u = this._sources.indexOf(l.source)),
            (c += ct.encode(u - o)),
            (o = u),
            (c += ct.encode(l.originalLine - 1 - n)),
            (n = l.originalLine - 1),
            (c += ct.encode(l.originalColumn - i)),
            (i = l.originalColumn),
            l.name != null &&
    ...
    j.prototype._generateSourcesContent = function (e, t) {
      return e.map(function (i) {
        if (!this._sourcesContents) return null;
        t != null && (i = E.relative(t, i));
        var n = E.toSetString(i);
    ...
    Bs.SourceMapGenerator = j;
  });
  var zs = v((_e) => {
    _e.GREATEST_LOWER_BOUND = 1;
    _e.LEAST_UPPER_BOUND = 2;
    ...
    _e.search = function (e, t, i, n) {
      if (t.length === 0) return -1;
      var s = ui(-1, t.length, e, t, i, n || _e.GREATEST_LOWER_BOUND);
      if (s < 0) return -1;
    ...
    function hi(r, e, t, i) {
      if (t < i) {
        ...
        for (var o = r[i], a = t; a < i; a++)
          e(r[a], o) <= 0 && ((s += 1), di(r, s, a));
        di(r, s + 1, a);
        var c = s + 1;
        hi(r, e, t, c - 1), hi(r, e, c + 1, i);
      }
    }
    Fs.quickSort = function (r, e) {
      hi(r, e, 0, r.length - 1);
    };
  });
  var Zs = v((Jt) => {
    ...
    function I(r, e) {
      ...
      return (
        ...
        t.sections != null ? new J(t, e) : new A(t, e)
      );
    }
    I.fromSourceMap = function (r, e) {
      return A.fromSourceMap(r, e);
    };
    ...
    function A(r, e) {
      ...
      o && (o = y.normalize(o)),
        ...
        (this._names = Ne.fromArray(s.map(String), !0)),
        (this._sources = Ne.fromArray(n, !0)),
    ...
    A.prototype.consumer = I;
    A.prototype._findSourceIndex = function (r) {
      var e = r;
      if (
    ...
    A.fromSourceMap = function (e, t) {
      var i = Object.create(A.prototype),
        n = (i._names = Ne.fromArray(e._names.toArray(), !0)),
        s = (i._sources = Ne.fromArray(e._sources.toArray(), !0));
      ...
      return ut(i.__originalMappings, y.compareByOriginalPositions), i;
    };
    ...
    A.prototype._parseMappings = function (e, t) {
      for (
        ...
        if (e.charAt(d) === ";") i++, d++, (n = 0);
          ...
          for (
            g = new Ds(), g.generatedLine = i, w = d;
            w < l && !this._charIsMappingSeparator(e, w);
            w++
          );
          if (((b = e.slice(d, w)), (m = u[b]), m)) d += b.length;
          else {
            for (m = []; d < w; )
              Lc.decode(e, d, h), (P = h.value), (d = h.rest), m.push(P);
            if (m.length === 2)
      ...
      ut(p, y.compareByGeneratedPositionsDeflated),
        (this.__generatedMappings = p),
        ut(f, y.compareByOriginalPositions),
        (this.__originalMappings = f);
    };
    A.prototype._findMapping = function (e, t, i, n, s, o) {
      if (e[i] <= 0)
        throw new TypeError(
    ...
    function J(r, e) {
      ...
      if (i != this._version) throw new Error("Unsupported version: " + i);
      (this._sources = new Ne()), (this._names = new Ne());
    ...
    J.prototype.originalPositionFor = function (e) {
      var t = {
        ...
        i = pi.search(t, this._sections, function (s, o) {
    ...
    J.prototype._parseMappings = function (e, t) {
      ...
      ut(this.__generatedMappings, y.compareByGeneratedPositionsDeflated),
        ut(this.__originalMappings, y.compareByOriginalPositions);
    };
    Jt.IndexedSourceMapConsumer = J;
  });
  var Gs = v((Ks) => {
    var Pc = ci().SourceMapGenerator,
      Qt = Re(),
      Tc = /(\r?\n)/,
      Ic = 10,
      Oe = "$$$isSourceNode$$$";
    ...
    z.fromStringWithSourceMap = function (e, t, i) {
      ...
      return (
        ...
        t.sources.forEach(function (h) {
          ...
          f != null &&
            (i != null && (h = Qt.join(i, h)), n.setSourceContent(h, f));
        }),
        n
      );
      function u(h, f) {
        if (h === null || h.source === void 0) n.add(f);
          ...
          var p = i ? Qt.join(i, h.source) : h.source;
    ...
    z.prototype.add = function (e) {
      ...
      else if (e[Oe] || typeof e == "string") e && this.children.push(e);
      else
        throw new TypeError(
    ...
    z.prototype.prepend = function (e) {
      ...
      else if (e[Oe] || typeof e == "string") this.children.unshift(e);
      else
        throw new TypeError(
          "Expected a SourceNode, string, or an array of SourceNodes and strings. Got " +
            e,
    ...
    z.prototype.walkSourceContents = function (e) {
      for (var t = 0, i = this.children.length; t < i; t++)
        this.children[t][Oe] && this.children[t].walkSourceContents(e);
      for (
        var n = Object.keys(this.sourceContents), t = 0, i = n.length;
        t < i;
        t++
      )
        e(Qt.fromSetString(n[t]), this.sourceContents[n[t]]);
    };
  ...
  var Ws = v(($t) => {
    $t.SourceMapGenerator = ci().SourceMapGenerator;
    $t.SourceMapConsumer = Zs().SourceMapConsumer;
    $t.SourceNode = Gs().SourceNode;
  });
  var Qs = v((Xt, Js) => {
    "use strict";
    Xt.__esModule = !0;
    ...
    ke ||
      ...
      (ke.prototype = {
        add: function (e) {
          mi.isArray(e) && (e = e.join("")), (this.src += e);
        },
        prepend: function (e) {
          mi.isArray(e) && (e = e.join("")), (this.src = e + this.src);
        },
...
`,
      ...
      empty: function () {
        ...
        return new ke(e.start.line, e.start.column, this.srcFile);
      },
      wrap: function (e) {
        var t =
          arguments.length <= 1 || arguments[1] === void 0
        ...
        return e instanceof ke
          ? e
          : ((e = fi(e, this, t)),
            new ke(t.start.line, t.start.column, this.srcFile, e));
      },
    ...
    He.prototype = {
      ...
      compile: function (e, t, i, n) {
        ...
        if (
          ...
          throw new gi.default("Compile completed with content left on stack");
...
`),
      ...
      preamble: function () {
        (this.lastContext = 0),
          (this.source = new Xs.default(this.options.srcName)),
          (this.decorators = new Xs.default(this.options.srcName));
      },
...
`),
    ...
    `.trim();
      ...
      resolvePath: function (e, t, i, n, s) {
        ...
        if (this.options.strict || this.options.assumeObjects) {
          this.push(Rc(this.options.strict && s, this, t, i, e));
          return;
        }
      ...
      replaceStack: function (e) {
        var t = ["("],
          ...
          s = void 0;
        if (!this.isInline())
          throw new gi.default("replaceStack on non-inline");
      ...
      popStack: function (e) {
        ...
        if (!t) {
          if (!this.stackSlot) throw new gi.default("Invalid stack pop");
          this.stackSlot--;
        }
        return i;
      },
    ...
    He.isValidJavaScriptVariableName = function (r) {
      return !He.RESERVED_WORDS[r] && /^[a-zA-Z_$][0-9a-zA-Z_$]*$/.test(r);
    };
  ...
  var no = v((er, io) => {
    ...
    var Nc = ss(),
      ...
      Dc = Dr(),
      Zc = dt(Dc),
      Kc = Oc.default.create;
    function ro() {
      var r = Kc();
      return (
        (r.compile = function (e, t) {
          return vi.compile(e, t, r);
        }),
        (r.precompile = function (e, t) {
          return vi.precompile(e, t, r);
        }),
        (r.AST = Hc.default),
        (r.Compiler = vi.Compiler),
        (r.JavaScriptCompiler = zc.default),
        (r.Parser = bi.parser),
        (r.parse = bi.parse),
        (r.parseWithoutProcessing = bi.parseWithoutProcessing),
        r
      );
    }
    var Be = ro();
    Be.create = ro;
    Zc.default(Be);
    Be.Visitor = Vc.default;
    Be.default = Be;
    er.default = Be;
    io.exports = er.default;
  });
  var X = v((tr) => {
    "use strict";
  ...
  var ki = v((Fe) => {
    ...
    Fe.waitUtilAsync = Fe.waitUntil = void 0;
    var $c = x(),
      ze = new $c.BasicTool();
    function Xc(r, e, t = 100, i = 1e4) {
      let n = Date.now(),
        s = ze.getGlobal("setInterval")(() => {
          r()
            ? (ze.getGlobal("clearInterval")(s), e())
            : Date.now() - n > i && ze.getGlobal("clearInterval")(s);
        }, t);
    }
    Fe.waitUntil = Xc;
    function Yc(r, e = 100, t = 1e4) {
      return new Promise((i, n) => {
        let s = Date.now(),
          o = ze.getGlobal("setInterval")(() => {
            r()
              ? (ze.getGlobal("clearInterval")(o), i())
              : Date.now() - s > t && (ze.getGlobal("clearInterval")(o), n());
          }, e);
      });
    }
    Fe.waitUtilAsync = Yc;
  ...
  var xi = v((rr) => {
    ...
    rr.ReaderTool = void 0;
    var eu = x(),
      tu = ki(),
      wi = class extends eu.BasicTool {
        ...
        async addReaderTabPanelDeckObserver(e) {
          await (0, tu.waitUtilAsync)(() => !!this.getReaderTabPanelDeck());
  ...
  var oo = v((ir) => {
    ...
    ir.ExtraFieldTool = void 0;
    var ru = x(),
      Si = class extends ru.BasicTool {
...
`),
    ...
    ir.ExtraFieldTool = Si;
  });
  var Li = v((nr) => {
    "use strict";
    Object.defineProperty(nr, "__esModule", { value: !0 });
    nr.PatchHelper = void 0;
    var iu = x(),
      Ci = class extends iu.BasicTool {
        constructor() {
  ...
  var or = v((sr) => {
    ...
    sr.FieldHookManager = void 0;
    var Pi = Li(),
      nu = x(),
      Ti = class extends nu.ManagerTool {
        constructor(e) {
          super(e),
            (this.data = { getField: {}, setField: {}, isFieldOfBase: {} }),
            (this.patchHelpers = {
              getField: new Pi.PatchHelper(),
              setField: new Pi.PatchHelper(),
              isFieldOfBase: new Pi.PatchHelper(),
            });
          let t = this;
    ...
    sr.FieldHookManager = Ti;
  });
  var Ei = v((ar) => {
    "use strict";
    Object.defineProperty(ar, "__esModule", { value: !0 });
    ar.PatcherManager = void 0;
    var su = x(),
      Ii = class extends su.ManagerTool {
        constructor(e) {
  ...
  var ao = v((Ve) => {
    ...
    Ve.ItemTreeManager = void 0;
    var au = x(),
      lu = or(),
      cu = ou(ae()),
      uu = Ei(),
      Ai = class extends au.ManagerTool {
        constructor(e) {
          super(e),
            (this.defaultPersist = [
              "width",
            ...
            (this.fieldHooks = new lu.FieldHookManager(e)),
            (this.patcherManager = new uu.PatcherManager(e)),
        ...
        async initializeGlobal() {
          ...
          this.globalCache = cu.default.getInstance().itemTree;
  ...
  var lo = v((de) => {
    ...
    de.PromptManager = de.Prompt = void 0;
    var hu = x(),
      pu = x(),
      fu = X(),
      mu = du(ae()),
      lr = class {
        ...
        constructor() {
          (this.lastInputText = ""),
            ...
            (this.commands = []),
            (this.base = new hu.BasicTool()),
            (this.ui = new fu.UITool()),
            this.initializeUI();
        }
        initializeUI() {
          this.addStyle(),
        ...
        async showSuggestions(e) {
          ...
          function o(h, f, p, g) {
            ...
            for (
              var b = p.toLowerCase(), m = 0, w = 0, P = [], C = 0;
              C < h.length;
              C++
            ) {
              var F = h[C],
              ...
              if (L === -1) return null;
              var S = p.charAt(L);
              if (L > 0 && !t.test(S) && !n.test(S)) {
                var pe = p.charAt(L - 1);
                if (
                  (S.toLowerCase() !== S && pe.toLowerCase() !== pe) ||
                  (S.toUpperCase() !== S &&
                    !t.test(pe) &&
                    !i.test(pe) &&
                    !n.test(pe))
              ...
              if (P.length === 0) P.push([L, L + F.length]);
              else {
                var Y = P[P.length - 1];
                Y[1] < L ? P.push([L, L + F.length]) : (Y[1] = L + F.length);
              }
              w = L + F.length;
            }
            return { matches: P, score: s(P, f.length, b.length, m) };
          }
          function a(h) {
            for (
              ...
              .forEach((h) => {
                ...
                if (g) {
                  ...
                  for (let w = 0; w < g.matches.length; w++) {
                    let [P, C] = g.matches[w];
                    P > m && (b += p.slice(m, P)),
                      (b += `<span class="highlight">${p.slice(P, C)}</span>`),
                      (m = C);
                  }
    ...
    de.Prompt = lr;
    var Mi = class extends pu.ManagerTool {
      constructor(e) {
        super(e), (this.commands = []);
        let t = mu.default.getInstance().prompt;
        t._ready || ((t._ready = !0), (t.instance = new lr())),
  ...
  var co = v((cr) => {
    ...
    cr.LibraryTabPanelManager = void 0;
    var gu = X(),
      bu = x(),
      Ri = class extends bu.ManagerTool {
        constructor(e) {
          super(e),
            (this.ui = new gu.UITool(this)),
    ...
    cr.LibraryTabPanelManager = Ri;
  });
  var uo = v((ur) => {
    "use strict";
    Object.defineProperty(ur, "__esModule", { value: !0 });
    ur.ReaderTabPanelManager = void 0;
    var vu = X(),
      yu = xi(),
      _u = x(),
      Ni = class extends _u.ManagerTool {
        constructor(e) {
          super(e),
            (this.ui = new vu.UITool(this)),
            (this.readerTool = new yu.ReaderTool(this)),
            (this.readerTabCache = {
              optionsList: [],
              observer: void 0,
    ...
    ur.ReaderTabPanelManager = Ni;
  });
  var ho = v((dr) => {
    "use strict";
    Object.defineProperty(dr, "__esModule", { value: !0 });
    dr.MenuManager = void 0;
    var ku = X(),
      wu = x(),
      Oi = class extends wu.ManagerTool {
        constructor(e) {
          super(e), (this.ui = new ku.UITool(this));
        }
        register(e, t, i = "after", n) {
          let s;
          if (
            (typeof e == "string"
              ? (s = this.getGlobal("document").querySelector(qi[e]))
              : (s = e),
            !s)
          )
            return !1;
  ...
  var Bi = v((hr) => {
    ...
    hr.PreferencePaneManager = void 0;
    var xu = X(),
      Su = x(),
      Hi = class extends Su.ManagerTool {
        constructor(e) {
          super(e),
            (this.alive = !0),
            (this.ui = new xu.UITool(this)),
  ...
  var fo = v((Ze) => {
    ...
    var O = x(),
      ...
      Pu = x(),
      Tu = Cu(ae()),
      zi = class extends Pu.ManagerTool {
        constructor(e) {
          super(e),
            (this.ui = new Lu.UITool(this)),
        ...
        initializeGlobal() {
          ...
          (this.globalCache = Tu.default.getInstance().shortcut),
        ...
        getXULKeyCode(e) {
          let t = Object.values(De).findIndex((i) => i === e);
          if (t >= 0) return Object.values(De)[t];
        }
        getStandardKey(e, t) {
          return t && Object.keys(De).includes(t) ? De[t] : e;
        }
    ...
    function po(r) {
      return function () {
        var e;
        let t = O.BasicTool.getZotero().getMainWindow(),
    ...
    var Iu = ["key_copyCitation", "key_copyBibliography"],
      Eu = [
        ...
        },
        {
          ...
          modifiers: "accel,shift",
          callback: he("quicksearch"),
        },
        {
          id: "extensions.zotero.keys.saveToZotero",
          modifiers: "accel,shift",
          callback: he("saveToZotero"),
        },
        {
        ...
        },
        {
          ...
          modifiers: "accel,shift",
          callback: he("toggleAllRead"),
        },
        {
          id: "extensions.zotero.keys.toggleRead",
          modifiers: "accel,shift",
          callback: he("toggleRead"),
        },
      ],
      Au = [
        {
        ...
        },
        {
          ...
          key: "W",
          callback: () => {
            let r = O.BasicTool.getZotero().getMainWindow().Zotero_Tabs;
        ...
        },
        {
          ...
          key: "T",
          callback: () => {
            O.BasicTool.getZotero().getMainWindow().Zotero_Tabs.undoClose();
          },
        },
        {
          id: "selectNextTab",
          ...
          key: "Tab",
          callback: () => {
            O.BasicTool.getZotero().getMainWindow().Zotero_Tabs.selectPrev();
          },
        },
        {
          ...
          key: "Tab",
          callback: () => {
            O.BasicTool.getZotero().getMainWindow().Zotero_Tabs.selectNext();
          },
        },
        {
          id: "selectTab1",
          ...
          key: "1",
          callback: () => {
            O.BasicTool.getZotero().getMainWindow().Zotero_Tabs.jump(0);
          },
        },
        {
          id: "selectTab2",
          ...
          key: "2",
          callback: () => {
            O.BasicTool.getZotero().getMainWindow().Zotero_Tabs.jump(1);
          },
        },
        {
          id: "selectTab3",
          ...
          key: "3",
          callback: () => {
            O.BasicTool.getZotero().getMainWindow().Zotero_Tabs.jump(2);
          },
        },
        {
          id: "selectTab4",
          ...
          key: "4",
          callback: () => {
            O.BasicTool.getZotero().getMainWindow().Zotero_Tabs.jump(3);
          },
        },
        {
          id: "selectTab5",
          ...
          key: "5",
          callback: () => {
            O.BasicTool.getZotero().getMainWindow().Zotero_Tabs.jump(4);
          },
        },
        {
          id: "selectTab6",
          ...
          key: "6",
          callback: () => {
            O.BasicTool.getZotero().getMainWindow().Zotero_Tabs.jump(5);
          },
        },
        {
          id: "selectTab7",
          ...
          key: "7",
          callback: () => {
            O.BasicTool.getZotero().getMainWindow().Zotero_Tabs.jump(6);
          },
        },
        {
          id: "selectTab8",
          ...
          key: "8",
          callback: () => {
            O.BasicTool.getZotero().getMainWindow().Zotero_Tabs.jump(7);
          },
        },
        {
          id: "selectTabLast",
          ...
          key: "9",
          callback: () => {
            O.BasicTool.getZotero().getMainWindow().Zotero_Tabs.selectLast();
          },
        },
      ];
  });
  var mo = v((pr) => {
    ...
    pr.ClipboardHelper = void 0;
    var Mu = x(),
      Fi = class extends Mu.BasicTool {
        constructor() {
          super(),
            (this.filePath = ""),
    ...
    pr.ClipboardHelper = Fi;
  });
  var go = v((fr) => {
    "use strict";
    Object.defineProperty(fr, "__esModule", { value: !0 });
    fr.FilePickerHelper = void 0;
    var Ru = x(),
      Vi = class extends Ru.BasicTool {
    ...
    fr.FilePickerHelper = Vi;
  });
  var bo = v((mr) => {
    "use strict";
    Object.defineProperty(mr, "__esModule", { value: !0 });
    mr.ProgressWindowHelper = void 0;
    var Nu = x(),
      Zi = class extends Zotero.ProgressWindow {
        constructor(e, t = { closeOnClick: !0, closeTime: 5e3 }) {
          super(t),
            ...
            t.closeOtherProgressWindows &&
              Nu.BasicTool.getZotero().ProgressWindowSet.closeAll();
        }
        createLine(e) {
        ...
        getIcon(e, t) {
          return e && e in Di ? Di[e] : t;
        }
      };
    mr.ProgressWindowHelper = Zi;
    var Di = {
  ...
  var vo = v((gr) => {
    ...
    gr.VirtualizedTableHelper = void 0;
    var Ou = x(),
      Ki = class extends Ou.BasicTool {
        constructor(e) {
          super(), (this.window = e);
          let t = this.getGlobal("Zotero"),
            i = e.require;
    ...
    gr.VirtualizedTableHelper = Ki;
  });
  var _o = v((br) => {
    "use strict";
    Object.defineProperty(br, "__esModule", { value: !0 });
    br.DialogHelper = void 0;
    var qu = X(),
      Gi = class extends qu.UITool {
        constructor(e, t) {
          if ((super(), e <= 0 || t <= 0))
        ...
        u.addEventListener("beforeunload", function h(f) {
          Array.from(u.document.querySelectorAll("*[data-bind]")).forEach(
            (p) => {
              ...
              b &&
                g &&
                (w ? (g[b] = p[w]) : (g[b] = p.getAttribute(m || "value")));
            },
          ),
...
`;
  ...
  var ko = v((Ke) => {
    ...
    Ke.ReaderInstanceManager = void 0;
    var Fu = x(),
      Vu = zu(ae()),
      Wi = class extends Fu.ManagerTool {
        constructor(e) {
        ...
        initializeGlobal() {
          if (
            ((this.globalCache = Vu.default.getInstance().readerInstance),
            !this.globalCache._ready)
          ) {
            this.globalCache._ready = !0;
            let e = this.getGlobal("Zotero"),
  ...
  var wo = v((Ge) => {
    ...
    var Zu = x(),
      ...
      Gu = Ei(),
      Wu = Du(ae()),
      ji = class extends Zu.ManagerTool {
        constructor(e) {
          super(e),
            (this.initializationLock =
              this.getGlobal("Zotero").Promise.defer()),
            (this.localCache = []),
            (this.fieldHooks = new Ku.FieldHookManager()),
            (this.patcherManager = new Gu.PatcherManager()),
            this.initializeGlobal();
        }
        ...
        async initializeGlobal() {
          ...
          let t = this.getGlobal("window");
          this.globalCache = Wu.default.getInstance().itemBox;
          let i = this.globalCache,
            n = this.isZotero7();
          if (!i._ready) {
            i._ready = !0;
  ...
  var So = v((vr) => {
    ...
    vr.LargePrefHelper = void 0;
    var ju = x(),
      Ui = class extends ju.BasicTool {
        constructor(e, t, i = "default") {
          super(),
            ...
            i === "default"
              ...
              : i === "parser"
                ? (this.hooks = Uu)
                : (this.hooks = Object.assign(Object.assign({}, xo), i)),
            (this.innerObj = {});
        }
        asObject() {
  ...
  var Co = v((je) => {
    ...
    je.KeyModifier = je.KeyboardManager = void 0;
    var Ju = x(),
      Qu = ki(),
      Ji = class extends Ju.ManagerTool {
        constructor(e) {
          super(e),
            ...
            (this.triggerKeydown = (t) => {
              this._cachedKey
                ? this._cachedKey.merge(new We(t), { allowOverwrite: !1 })
                : (this._cachedKey = new We(t)),
                this.dispatchCallback(t, { type: "keydown" });
            }),
            (this.triggerKeyup = async (t) => {
              if (!this._cachedKey) return;
              let i = new We(this._cachedKey);
  ...
  var Qi = v((ht) => {
    ...
    var ne = x(),
      ...
      gd = Co(),
      bd = Li(),
      yr = class extends ne.BasicTool {
        constructor() {
          super(),
            (this.UI = new $u.UITool(this)),
            (this.Reader = new Xu.ReaderTool(this)),
            (this.ExtraField = new Yu.ExtraFieldTool(this)),
            (this.FieldHooks = new pd.FieldHookManager(this)),
            (this.ItemTree = new ed.ItemTreeManager(this)),
            (this.ItemBox = new fd.ItemBoxManager(this)),
            (this.Keyboard = new gd.KeyboardManager(this)),
            (this.Prompt = new td.PromptManager(this)),
            (this.LibraryTabPanel = new rd.LibraryTabPanelManager(this)),
            (this.ReaderTabPanel = new id.ReaderTabPanelManager(this)),
            (this.ReaderInstance = new hd.ReaderInstanceManager(this)),
            (this.Menu = new nd.MenuManager(this)),
            (this.PreferencePane = new sd.PreferencePaneManager(this)),
            (this.Shortcut = new od.ShortcutManager(this)),
            (this.Clipboard = (0, ne.makeHelperTool)(ad.ClipboardHelper, this)),
            (this.FilePicker = (0, ne.makeHelperTool)(
              ld.FilePickerHelper,
              this,
            )),
            (this.Patch = (0, ne.makeHelperTool)(bd.PatchHelper, this)),
            (this.ProgressWindow = (0, ne.makeHelperTool)(
              cd.ProgressWindowHelper,
              this,
            )),
            (this.VirtualizedTable = (0, ne.makeHelperTool)(
              ud.VirtualizedTableHelper,
              this,
            )),
            (this.Dialog = (0, ne.makeHelperTool)(dd.DialogHelper, this)),
            (this.LargePrefObject = (0, ne.makeHelperTool)(
              md.LargePrefHelper,
              this,
            ));
        }
        unregisterAll() {
          (0, ne.unregister)(this);
        }
      };
    ht.ZoteroToolkit = yr;
    ht.default = yr;
  ...
  function fn() {
    ...
    let r = new (
      typeof Localization > "u"
        ...
        : Localization
    )([`${R.addonRef}-addon.ftl`], !0);
    ztoolkit.log(r), (addon.data.locale = { current: r });
  }
  function Te(...r) {
    if (r.length === 1) return Sr(r[0]);
    if (r.length === 2)
  ...
  function yt(r) {
    return Zotero.Prefs.get(`${R.prefsPrefix}.${r}`, !0);
  }
  var Ie = JSON.parse(String(yt("statuses"))),
    _t = String(yt("status-tag-prefix")),
    le = _t + String(yt("reason-tag-prefix"));
  function mn(r) {
    return r.getTags().filter((i) => i.tag.includes(_t));
  }
  function gn(r) {
  ...
  function Cr(r) {
    return r
      .filter((e) => e.tag.includes(le))
      .map((e) => {
        let t = e.tag.replace(le, "");
  ...
  function bn(r) {
    r.getTags().map((e) => {
      e.tag.includes(_t) && r.removeTag(e.tag);
    });
  }
  function vn(r) {
    return (
...
`);
  ...
  function $i(r) {
    ...
    function pe() {
      ...
      let _ = 0,
        k;
      function M() {
        let Z = e.documentElement,
          T = Z.clientTop || e.body.clientTop || 0,
          Se = Z.clientLeft || e.body.clientLeft || 0,
          H = window.pageYOffset || Z.scrollTop,
          U = window.pageXOffset || Z.scrollLeft;
        k = m.getBoundingClientRect();
        let an = k.top + m.offsetHeight + H - T,
          ln = k.left + U - Se;
        (n.top = an + "px"),
          (n.left = ln + "px"),
      ...
      M(), M(), r.customize && k && r.customize(m, k, t, _);
    }
    function Y() {
      (t.textContent = ""), m.setAttribute("aria-activedescendant", "");
      let _ = function (T, Se, H) {
        let U = e.createElement("div");
        return (U.textContent = T.label || ""), U;
      };
      r.render && (_ = r.render);
      let k = function (T, Se) {
        let H = e.createElement("div");
        return (H.textContent = T), H;
      };
      r.renderGroup && (k = r.renderGroup);
      let M = e.createDocumentFragment(),
        Z = w();
      if (
        (c.forEach(function (T, Se) {
          if (T.group && T.group !== Z) {
            Z = T.group;
            let U = k(T.group, l);
            U && ((U.className += " group"), M.appendChild(U));
          }
          let H = _(T, l, Se);
          H &&
            ((H.id = `${t.id}_${Se}`),
            ...
            T === h &&
              ...
              m.setAttribute("aria-activedescendant", H.id)),
            M.appendChild(H));
        }),
        t.appendChild(M),
        c.length < 1)
        ...
        if (r.emptyMsg) {
          ...
          (T.id = `${t.id}_${w()}`),
            (T.className = "empty"),
            (T.textContent = r.emptyMsg),
            t.appendChild(T),
            m.setAttribute("aria-activedescendant", T.id);
        } else {
          S();
          return;
        }
    ...
    function Ue(_) {
      _.target !== t ? fe() : _.preventDefault();
    }
    function me() {
      b || Je(0);
    }
    function xe() {
      let _ = t.getElementsByClassName("selected");
      if (_.length > 0) {
        let k = _[0],
          M = k.previousElementSibling;
        if (
          (M &&
            M.className.indexOf("group") !== -1 &&
          ...
          let Z = k.offsetTop + k.offsetHeight,
    ...
    function Bo(_, k) {
      ...
      if (k === "Escape") S();
        ...
        if (!M || c.length < 1) return;
        k === "ArrowUp" ? D() : Oo();
      }
      _.preventDefault(), M && _.stopPropagation();
    }
    function zo(_) {
      if (h) {
        i === 2 && _.preventDefault(), (b = !0);
        try {
          r.onSelect(h, m);
        } finally {
          b = !1;
    ...
    function Je(_) {
      m.value.length >= d || _ === 1
        ? (C(),
          (p = window.setTimeout(
            () => rn(m.value, _, m.selectionStart || 0),
            _ === 0 || _ === 2 ? s : 0,
          )))
        : S();
    }
    function rn(_, k, M) {
      ...
      r.fetch(
        ...
        function (T) {
          f === Z &&
            T &&
            ((c = T), (l = _), (h = c.length < 1 || o ? void 0 : c[0]), Y());
        },
        k,
        M,
      );
    ...
    function nn(_) {
      if (r.keyup) {
        r.keyup({ event: _, fetch: () => Je(0) });
        return;
      }
      !L() && _.key === "ArrowDown" && Je(0);
    }
    function sn(_) {
      r.click && r.click({ event: _, fetch: () => Je(2) });
    }
    function on() {
      setTimeout(() => {
        e.activeElement !== m && S();
    ...
    function Vo() {
      m.removeEventListener("focus", tn),
        ...
        m.removeEventListener("input", me),
        m.removeEventListener("blur", on),
        window.removeEventListener("resize", V),
        e.removeEventListener("scroll", Ue, !0),
  ...
  var kd = { renderCell: _d },
    wd = "456",
    xd = (r, e, t, i) =>
      mn(i)
        .find((o) => o.tag.includes(le))
        ?.tag.replace(le, "") ?? "",
    Sd = {};
  var se = class {
    static registerStyleSheet() {
      let e = ztoolkit.UI.createElement(document, "link", {
        properties: {
          type: "text/css",
          rel: "stylesheet",
          href: `chrome://${R.addonRef}/content/zoteroPane.css`,
        },
      });
      document.documentElement.appendChild(e);
    }
    static registerExtraColumnWithBindings() {
      let e = Te("status-column-header");
      ztoolkit.ItemTree.register(vd, e, yd, kd);
      let t = Te("reason-column-header");
      ztoolkit.ItemTree.register(wd, t, xd, Sd);
      let i = Ie.map((n) => ({
        tag: "menuitem",
        label: n.label,
        icon: vn(n.color),
      ...
      i.push({ tag: "menuseparator" }),
        ...
        (ztoolkit.getGlobal("document").setReviewStatus = (n) => {
          ...
          for (let a of s) bn(a), n != "" && a.addTag(n), a.saveTx();
          Lr(n)?.askForReason && document.setStatusReason();
        }),
        (ztoolkit.getGlobal("document").setStatusReason = async () => {
          document.allReasons = Cr(
            await ztoolkit.getGlobal("Zotero").Tags.getAll(),
          );
          let n = document.reasonModal.element.querySelector("#input-reason");
          (n.value = ""), document.reasonModal.open(), n.focus();
        });
    }
    static async registerDOMElements() {
      let e = document.createElement("div"),
        t = document.createElement("div");
      (t.textContent = Te("reason-dialog-text")), e.appendChild(t);
      ...
      (l.type = "submit"),
        ...
        (i.onsubmit = () => {
          ...
          for (let h of u)
            h.getTags().map((f) => {
              f.tag.includes(le) && h.removeTag(f.tag);
            }),
              n.value != "" && h.addTag(le + n.value),
              h.saveTx();
          d.close();
        });
      let d = so("reason-modal", Te("reason-dialog-title"), e);
  ...
  ft([kt], se, "registerStyleSheet", 1),
    ft([kt], se, "registerExtraColumnWithBindings", 1),
    ft([kt], se, "registerDOMElements", 1);
  var To = Ce(Qi());
  var Io = Ce(x()),
    Ld = Ce(X()),
    Pd = Ce(Bi());
  function _r() {
    let r = new To.default();
    return Cd(r), r;
  }
  function Cd(r) {
    let e = "production";
    (r.basicOptions.log.prefix = `[${R.addonName}]`),
      ...
      (r.basicOptions.api.pluginID = R.addonID),
      r.ProgressWindow.setIconURI(
        "default",
        `chrome://${R.addonRef}/content/icons/favicon.png`,
      );
  }
  async function Td() {
    await Promise.all([
      ...
      fn(),
      se.registerExtraColumnWithBindings(),
      await Eo(window);
  }
  async function Eo(r) {
    (addon.data.ztoolkit = _r()),
      se.registerDOMElements(),
      se.registerStyleSheet(),
  ...
  var Xi = class {
      constructor() {
        (this.data = { alive: !0, env: "production", ztoolkit: _r() }),
          (this.hooks = Ao),
          (this.api = {});
      }
    },
    Mo = Xi;
  var No = new Ro.BasicTool();
  No.getGlobal("Zotero")[R.addonInstance] ||
    (pt("window"),
    pt("document"),
    pt("ZoteroPane"),
    pt("Zotero_Tabs"),
    (_globalThis.addon = new Mo()),
    pt("ztoolkit", () => _globalThis.addon.data.ztoolkit),
    (Zotero[R.addonInstance] = addon));
  function pt(r, e) {
    Object.defineProperty(_globalThis, r, {
      get() {
        return e ? e() : No.getGlobal(r);
      },
    });
  }
})();
