...
(() => {
  ...
  var U = (i, e, t) => (
    ...
    Yt(
      e || !i || !i.__esModule
        ? Re(t, "default", { value: i, enumerable: !0 })
        : t,
      i,
    )
  );
  ...
  var L = v((X) => {
    ...
    var Ae = y(),
      ...
      le = class i {
        constructor() {
          yt(this),
            (this.currentWindow = Ae.BasicTool.getZotero().getMainWindow());
        }
        static getInstance() {
          let e = Ae.BasicTool.getZotero(),
            t = !1;
    ...
    function yt(i) {
      G(i, "fieldHooks", {
        ...
        G(i, "itemTree", { _ready: !1, columns: [], renderCellHooks: {} }),
        G(i, "itemBox", { _ready: !1, fieldOptions: {} }),
        G(i, "shortcut", { _ready: !1, eventKeys: [] }),
        G(i, "prompt", { _ready: !1, instance: void 0 }),
        G(i, "readerInstance", { _ready: !1, initializedHooks: {} }),
    ...
    function si(i) {
      (i.currentWindow = Ae.BasicTool.getZotero().getMainWindow()),
        (i.itemTree = void 0),
        (i.itemBox = void 0),
        (i.shortcut = void 0),
        (i.prompt = void 0),
    ...
    var Vi = y(),
      ...
      Ge = class extends Vi.BasicTool {
        ...
        async addReaderTabPanelDeckObserver(e) {
          await (0, Ai.waitUtilAsync)(() => !!this.getReaderTabPanelDeck());
...
`),
      ...
      $e = class extends Ki.ManagerTool {
        constructor(e) {
          super(e),
            ...
            (this.patchHelpers = {
              getField: new Me.PatchHelper(),
              setField: new Me.PatchHelper(),
              isFieldOfBase: new Me.PatchHelper(),
            });
          let t = this;
  ...
  var je = v((be) => {
    ...
    var Gi = y(),
      Ee = class extends Gi.ManagerTool {
        constructor(e) {
      ...
      De = class extends Hi.ManagerTool {
        constructor(e) {
          super(e),
            ...
            (this.patcherManager = new Mi.PatcherManager(e)),
        ...
        async initializeGlobal() {
          ...
          this.globalCache = Wi.default.getInstance().itemTree;
  ...
  var _t = v((Z) => {
    ...
    Z.PromptManager = Z.Prompt = void 0;
    var Ei = y(),
      ji = y(),
      Di = P(),
      Oi = $i(L()),
        ...
        async showSuggestions(e) {
          ...
          function a(u, g, h, p) {
            ...
            for (
              ...
              if (x.length === 0) x.push([_, _ + q.length]);
              else {
                var ft = x[x.length - 1];
                ft[1] < _ ? x.push([_, _ + q.length]) : (ft[1] = _ + q.length);
              }
              k = _ + q.length;
            }
    ...
    var T = y(),
      ...
      tt = class extends nr.ManagerTool {
        ...
        checkKeyConflicting(e, t = { includeEmpty: !1, customKeys: [] }) {
          var r;
          e.modifiers = new A(e.modifiers || "").getRaw();
          let o = this.getAll();
          return (
          ...
          (this.globalCache = ar.default.getInstance().shortcut),
            this.globalCache._ready ||
              ...
              t.addEventListener("keypress", (r) => {
                ...
                let a = new A(o.join(",")).getRaw(),
                  n = new A(o.join(",")).getRaw();
                this.globalCache.eventKeys.forEach((l) => {
                  var d;
                  if (l.disabled) return;
                  let c = new A(l.modifiers || "").getRaw();
                  (c === a || c === n) &&
        ...
        getXULKeyCode(e) {
          let t = Object.values(M).findIndex((r) => r === e);
          if (t >= 0) return Object.values(M)[t];
        }
        getStandardKey(e, t) {
          return t && Object.keys(M).includes(t) ? M[t] : e;
        }
          ...
          return Array.from(
            ...
            keys: Array.from(r.querySelectorAll("key")).map((o) => {
              ...
              return {
                ...
                modifiers: new A(o.getAttribute("modifiers") || "").getRaw(),
    ...
    var lr = ["key_copyCitation", "key_copyBibliography"],
      cr = [
        ...
        },
        {
          ...
          modifiers: "accel,shift",
          callback: R("quicksearch"),
        },
        {
          id: "extensions.zotero.keys.saveToZotero",
          modifiers: "accel,shift",
          callback: R("saveToZotero"),
        },
        {
        ...
        },
        {
          ...
          modifiers: "accel,shift",
          callback: R("toggleAllRead"),
        },
        {
          id: "extensions.zotero.keys.toggleRead",
          modifiers: "accel,shift",
          callback: R("toggleRead"),
        },
      ],
      dr = [
        {
...
`;
        ...
        constructor(e, t, r = "default") {
          super(),
            ...
            r === "default"
              ...
              : r === "parser"
                ? (this.hooks = Pr)
                : (this.hooks = Object.assign(Object.assign({}, Gt), r)),
            (this.innerObj = {});
        }
        asObject() {
  ...
  var Bt = v((oe) => {
    ...
    var z = y(),
      ...
      Le = class extends z.BasicTool {
        constructor() {
          super(),
            (this.UI = new Zr.UITool(this)),
            (this.Reader = new Rr.ReaderTool(this)),
            ...
            (this.Prompt = new Ar.PromptManager(this)),
            (this.LibraryTabPanel = new qr.LibraryTabPanelManager(this)),
            ...
            (this.PreferencePane = new Gr.PreferencePaneManager(this)),
            (this.Shortcut = new Nr.ShortcutManager(this)),
            ...
            (this.ProgressWindow = (0, z.makeHelperTool)(
              Wr.ProgressWindowHelper,
              this,
            )),
            (this.VirtualizedTable = (0, z.makeHelperTool)(
              Mr.VirtualizedTableHelper,
              this,
            )),
  ...
  var w = {
    ...
    updateJSON:
      "https://raw.githubusercontent.com/alima-webdev/zotero-review/main/update.json?token=GHSAT0AAAAAACQKVFOAT6ZKLBSOWJFL25UKZQ52GGA",
  };
  function vt() {
    let i = new (
    ...
    static registerExtraColumnWithBindings() {
      ztoolkit.ItemTree.register(gi, pi, bi, vi),
        ...
        ztoolkit.Menu.register("item", {
          ...
          children: [
            ...
            },
            {
              ...
              oncommand: `document.setReviewStatus('${N}');`,
            },
            {
              tag: "menuitem",
        ...
        (ztoolkit.getGlobal("document").setReviewStatus = (e) => {
          ...
          e == N && document.setExclusionReason(),
  ...
  var ht = class {
      constructor() {
        (this.data = { alive: !0, env: "production", ztoolkit: Ze() }),
          (this.hooks = Et),
          (this.api = {});
      }
    },
