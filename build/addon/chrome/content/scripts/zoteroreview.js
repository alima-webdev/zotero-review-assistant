        ...
        initializeDebugBridge() {
          const debugBridgeExtension = {
            ...
            doAction: async (uri) => {
              ...
              const params = {};
              (_a = uriString.split("?").pop()) === null || _a === void 0
                ? void 0
                : _a.split("&").forEach((p) => {
                    params[p.split("=")[0]] = decodeURIComponent(
                      p.split("=")[1],
                    );
                  });
              const skipPasswordCheck =
                toolkitGlobal_1.default.getInstance().debugBridge
            ...
            doAction: async (uri) => {
              ...
              try {
                ...
                if (params.action === "install" && params.url) {
                  if (
                    (params.minVersion &&
                      Services.vc.compare(Zotero2.version, params.minVersion) <
                        0) ||
                    (params.maxVersion &&
                      Services.vc.compare(Zotero2.version, params.maxVersion) >
                        0)
                  ) {
                    throw new Error(
                  ...
                  const addon2 = await AddonManager.getInstallForURL(
                    params.url,
                  );
    ...
    "node_modules/zotero-plugin-toolkit/dist/managers/toolkitGlobal.js"(
      ...
      function setModule(instance, key, module3) {
        ...
        for (const moduleKey in module3) {
          (_a = (_b = instance[key])[moduleKey]) !== null && _a !== void 0
            ? _a
      ...
      var UITool2 = class extends basic_1.BasicTool {
        ...
        unregisterAll() {
          this.elementCache.forEach((e) => {
            var _a;
            try {
              (_a = e === null || e === void 0 ? void 0 : e.deref()) === null ||
              _a === void 0
                ? void 0
                : _a.remove();
            } catch (e2) {
        ...
        createElement(...args) {
          ...
          if (tagName === "fragment") {
            ...
            if (!realElem || !props.skipIfExists) {
              ...
              if (!namespace) {
                ...
                if (
                  Number(mightHTML) + Number(mightXUL) + Number(mightSVG) >
                  1
                ) {
                  this.log(
          ...
          if (
            (_c = props.children) === null || _c === void 0 ? void 0 : _c.length
          ) {
    ...
    "node_modules/zotero-plugin-toolkit/dist/tools/reader.js"(exports) {
      ...
      var ReaderTool = class extends basic_1.BasicTool {
          ...
          const annotation =
            ...
            (_a =
              reader === null || reader === void 0
                ? void 0
                : reader._internalReader._lastView._selectionPopup) === null ||
            _a === void 0
              ? void 0
              : _a.annotation;
          return annotation;
        ...
        getSelectedText(reader) {
          var _a, _b;
          return (_b =
            (_a = this.getSelectedAnnotationData(reader)) === null ||
            _a === void 0
              ? void 0
        ...
        getExtraFields(item, backend = "custom") {
          ...
          if (backend === "default") {
            return this.getGlobal(
              "Zotero",
            ).Utilities.Internal.extractExtraFields(extraFiledRaw).fields;
          } else {
    ...
    "node_modules/zotero-plugin-toolkit/dist/managers/itemTree.js"(exports) {
      ...
      var ItemTreeManager = class extends basic_1.ManagerTool {
        ...
        async register(
          ...
          var _a;
          await ((_a = this.initializationLock) === null || _a === void 0
            ? void 0
            : _a.promise);
          if (!this.backend) {
            if (
              this.globalCache.columns.map((_c) => _c.dataKey).includes(key)
            ) {
          ...
          const column = {
            ...
            dataProvider:
              options.dataProvider || ((item, _dataKey) => item.getField(key)),
            ...
            this.patcherManager.register(
              ...
              (original) =>
                function (index, data, column) {
                  ...
                  const span = window2.document.createElementNS(
        ...
        async refresh() {
          ...
          (_b = document.querySelector(`.${virtualizedTable._styleKey}`)) ===
            null || _b === void 0
            ? void 0
            : _b.remove();
      ...
      var ReaderTabPanelManager = class extends basic_1.ManagerTool {
        ...
        unregister(tabId) {
          ...
          if (this.readerTabCache.optionsList.length === 0) {
            (_a = this.readerTabCache.observer) === null || _a === void 0
              ? void 0
              : _a.disconnect();
            this.readerTabCache = {
              optionsList: [],
  ...
  var require_menu = __commonJS({
    "node_modules/zotero-plugin-toolkit/dist/managers/menu.js"(exports) {
      ...
      var MenuManager = class extends basic_1.ManagerTool {
        ...
        register(menuPopup, options, insertPosition = "after", anchorElement) {
          ...
          const generateElementOptions = (menuitemOption) => {
            ...
            if (menuitemOption.commandListener) {
              (_a = elementOption.listeners) === null || _a === void 0
                ? void 0
                : _a.push({
                    type: "command",
        ...
        unregister(menuId) {
          var _a;
          (_a = this.getGlobal("document").querySelector(`#${menuId}`)) ===
            null || _a === void 0
            ? void 0
            : _a.remove();
        }
              ...
              for (let mutation of mutations) {
                if (mutation.type == "attributes") {
                  ...
                  for (let node of Array.from(mutation.addedNodes)) {
                    if (
                      node.nodeType == window2.Node.ELEMENT_NODE &&
                      ...
                      node.addEventListener(
                        this.isXULElement(node) ? "command" : "input",
                        syncToPrefOnModify,
                      );
                    }
                  }
              ...
              win.addEventListener(
                ...
                async () => {
                  ...
                  if (
                    ...
                    const contentOrXHR = await Zotero2.File.getContentsAsync(
                      options.src,
                    );
                    const content =
                ...
                ${content}
                    ...
                    const prefPane = win.document.querySelector(
                      `#${options.id}`,
                    );
                    ...
                    if (
                      (_a = options.scripts) === null || _a === void 0
                        ? void 0
                        : _a.length
                    ) {
    ...
    "node_modules/zotero-plugin-toolkit/dist/managers/shortcut.js"(exports) {
      ...
      var ShortcutManager = class extends basic_2.ManagerTool {
          ...
          return allKeys.filter((_keyOptions) => {
            ...
            return (
              ...
              ((_a2 = _keyOptions.key) === null || _a2 === void 0
                ? void 0
                : _a2.toLowerCase()) ===
                ((_b = inputKeyOptions.key) === null || _b === void 0
                  ? void 0
                  : _b.toLowerCase()) &&
        ...
        checkAllKeyConflicting(
          ...
          while (allKeys.length > 0) {
            ...
            const conflictKeys = allKeys.filter((_keyOptions) => {
              ...
              return (
                ((_a2 = _keyOptions.key) === null || _a2 === void 0
                  ? void 0
                  : _a2.toLowerCase()) ===
                  ((_b = checkKey.key) === null || _b === void 0
                    ? void 0
                    : _b.toLowerCase()) &&
            ...
            if (conflictKeys.length) {
              ...
              allKeys.forEach(
                (key, i) =>
                  conflictingKeyIds.includes(key.id) && toRemoveIds.push(i),
              );
              toRemoveIds
                .sort((a, b) => b - a)
        ...
        async unregister(keyOptions) {
          ...
          switch (keyOptions.type) {
            case "element":
              (_a = (
                keyOptions.xulData.document || this.getGlobal("document")
              ).querySelector(`#${keyOptions.id}`)) === null || _a === void 0
                ? void 0
                : _a.remove();
              return true;
            case "prefs":
            ...
            window2.addEventListener("keypress", (event) => {
              ...
              this.globalCache.eventKeys.forEach((keyOptions) => {
                ...
                if (
                  ...
                  ((_a = keyOptions.key) === null || _a === void 0
                    ? void 0
                    : _a.toLowerCase()) === event.key.toLowerCase()
                ) {
                  keyOptions.callback();
                }
              });
        ...
        registerElementCommandset(commandSetOptions) {
          var _a;
          (_a = commandSetOptions.document.querySelector("window")) === null ||
          _a === void 0
            ? void 0
            : _a.appendChild(
        ...
        registerElementKeyset(keySetOptions) {
          var _a;
          (_a = keySetOptions.document.querySelector("window")) === null ||
          _a === void 0
            ? void 0
            : _a.appendChild(
        ...
        registerElementKey(keyOptions) {
          ...
          (_a = doc.querySelector(`keyset#${keyOptions.xulData._parentId}`)) ===
            null || _a === void 0
            ? void 0
            : _a.appendChild(
              ...
              (keyElem) => {
                ...
                const key = {
                  ...
                  callback: () => {
                    ...
                    _eval(oncommand);
                    _eval(
                      (commandOptions === null || commandOptions === void 0
                        ? void 0
      ...
      function getElementKeyCallback(keyId) {
        return function () {
          ...
          _eval(
            ((_a = win.document.querySelector(`#${cmdId}`)) === null ||
            _a === void 0
              ? void 0
      ...
      var BUILTIN_KEYS = [
        ...
        },
        {
          ...
          callback: () => {
            const ztabs =
              basic_1.BasicTool.getZotero().getMainWindow().Zotero_Tabs;
    ...
    "node_modules/zotero-plugin-toolkit/dist/helpers/dialog.js"(exports) {
      ...
      function openDialog(
        ...
        win.addEventListener("unload", function onWindowUnload(ev) {
          var _a2, _b2, _c2;
          if (
            (_a2 = this.window.arguments[0]) === null || _a2 === void 0
              ? void 0
          ...
          (_c2 =
            (_b2 = this.window.arguments[0]) === null || _b2 === void 0
              ? void 0
          ...
          const customSelectProps = {
            ...
            children: [
                ...
                listeners: [
                  {
                    ...
                    listener: (ev) => {
                      ...
                      const dropdown =
                        (_a2 = select.parentElement) === null || _a2 === void 0
                          ? void 0
                          : _a2.querySelector(".dropdown-content");
              ...
              }),
              {
                ...
                children:
                  (_a = elementProps.children) === null || _a === void 0
                    ? void 0
                    : _a.map((option) => {
                        var _a2, _b2, _c2;
                        return {
                          ...
                          properties: {
                            innerHTML:
                              ((_b2 = option.properties) === null ||
                              _b2 === void 0
                                ? void 0
                                : _b2.innerHTML) ||
                              ((_c2 = option.properties) === null ||
                              _c2 === void 0
                                ? void 0
                                : _c2.innerText),
                          },
                          ...
                          listeners: [
                            {
                              ...
                              listener: (ev) => {
                                var _a3;
                                const select =
                                  (_a3 = ev.target.parentElement) === null ||
                                  _a3 === void 0
                                    ? void 0
          ...
          const href =
            ((_b =
              elementProps === null || elementProps === void 0
                ? void 0
                : elementProps.properties) === null || _b === void 0
              ? void 0
              : _b.href) || "";
...
`;
                  ...
                  for (const extraField of Object.values(
                    ...
                    if (extraField.collapsible) {
                      fieldHeader.addEventListener("click", function (ev) {
                        Zotero2.Prefs.set(
                          prefKey,
                          !(Zotero2.Prefs.get(prefKey, true) || false),
                          true,
                        );
                    ...
                    fieldHeader.addEventListener(
                      ...
                      inZotero7
                        ? function (ev) {
                            var _a;
                            const inputField =
                              (_a = ev.currentTarget.nextElementSibling) ===
                                null || _a === void 0
                                ? void 0
                                : _a.querySelector("input, textarea");
                            if (inputField) {
                              inputField.blur();
                            }
                          }
          ...
          (0, wait_1.waitUntil)(
            () => {
              ...
              return (
                ...
                ((_b =
                  (_a = reader._internalReader) === null || _a === void 0
                    ? void 0
                    : _a._primaryView) === null || _b === void 0
                  ? void 0
                  : _b._iframeWindow)
              );
            },
            () => {
              ...
              return this._initKeyboardListener(
                (_a = reader._internalReader._primaryView) === null ||
                  _a === void 0
                  ? void 0
                  : _a._iframeWindow,
              );
      ...
      var KeyModifier = class _KeyModifier {
        constructor(raw, options) {
          ...
          if (typeof raw === "undefined") {
            ...
            if (
              options === null || options === void 0 ? void 0 : options.useAccel
            ) {
              if (Zotero.isMac) {
            ...
            this.alt = raw.altKey;
            if (
              !["Shift", "Meta", "Ctrl", "Alt", "Control"].includes(raw.key)
            ) {
              this.key = raw.key;
            }
          }
    ...
    "node_modules/zotero-plugin-toolkit/dist/index.js"(exports) {
      ...
      var ZoteroToolkit2 = class extends basic_1.BasicTool {
        constructor() {
          ...
          this.LibraryTabPanel = new libraryTabPanel_1.LibraryTabPanelManager(
            this,
          );
          this.ReaderTabPanel = new readerTabPanel_1.ReaderTabPanelManager(
            this,
          );
          this.ReaderInstance = new readerInstance_1.ReaderInstanceManager(
            this,
          );
          this.Menu = new menu_1.MenuManager(this);
          this.PreferencePane = new preferencePane_1.PreferencePaneManager(
            this,
          );
  ...
  var reasonTagPrefix = statusTagPrefix + String(getPref("reason-tag-prefix"));
...
`);
      ...
      settings.fetch(
        ...
        function (elements) {
          if (fetchCounter === savedFetchCounter && elements) {
            ...
            selected =
              items.length < 1 || disableAutoSelect ? void 0 : items[0];
            update();
          }
        },
        trigger,
  ...
  var autocomplete_es_default = autocomplete;

  // src/ui/itemTree.ts
  var columnId = "123";
  var getStatusColumnHook = (field, unformatted, includeBaseMapped, item) => {
  ...
  var columnOptions = { renderCell: renderStatusCell };
  var columnReasonId = "456";
  var getReasonColumnHook = (field, unformatted, includeBaseMapped, item) => {
  ...
  var ReviewModule = class {
    ...
    static registerExtraColumnWithBindings() {
      ...
      const statusMenuChildren = allStatuses.map((status) => {
        return {
          tag: "menuitem",
          label: status.label,
  ...
  __decorateClass([module], ReviewModule, "registerExtraColumnWithBindings", 1);
