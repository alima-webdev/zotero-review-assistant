  ...
  var Sn = v((Ae) => {
    ...
    var Rr = x(),
      ...
      rt = class r {
        ...
        get password() {
          return Rr.BasicTool.getZotero().Prefs.get(r.passwordPref, !0);
        }
        set password(e) {
...
If you do not know what it is, please click Cancel to deny.`))
    ...
    Ae.DebugBridge = rt;
    rt.version = 2;
    rt.passwordPref = "extensions.zotero.debug-bridge.password";
  });
  var Cn = v((Ct) => {
    "use strict";
                ...
                try {
                  ...
                  if (
                    ...
                    if (c && c.state === e.STATE_AVAILABLE)
                      c.install(), xn("Plugin installed successfully.", !0);
  ...
  var pe = v((it) => {
    ...
    var Nr = x(),
      ...
      Lt = class r {
        constructor() {
          Ln(this),
            (this.currentWindow = Nr.BasicTool.getZotero().getMainWindow());
        }
        static getInstance() {
          ...
          return (
            i.currentWindow !== e.getMainWindow() && (Ia(i), (t = !0)),
            t && Ln(i),
            i
          );
        }
...
`),
    ...
    function Ra(r, e) {
      return new Proxy(r, {
        construct(t, i) {
          let n = new r(...i);
          return n instanceof nt && n.updateOptions(e), n;
        },
      });
    }
    U.makeHelperTool = Ra;
    ...
    var Ua = x(),
      ...
      Vr = class extends Ua.BasicTool {
        ...
        async addReaderTabPanelDeckObserver(e) {
          await (0, Ja.waitUtilAsync)(() => !!this.getReaderTabPanelDeck());
      ...
      Bt = class {
        ...
        async showSuggestions(e) {
          ...
          function o(h, f, p, g) {
            ...
            for (
              var b = p.toLowerCase(), m = 0, S = 0, E = [], P = 0;
              P < h.length;
              P++
            ) {
              var Z = h[P],
              ...
              if (E.length === 0) E.push([T, T + Z.length]);
                ...
                var ne = E[E.length - 1];
                ne[1] < T ? E.push([T, T + Z.length]) : (ne[1] = T + Z.length);
              }
              S = T + Z.length;
            }
            return { matches: E, score: s(E, f.length, b.length, m) };
          }
          function a(h) {
            for (
    ...
    var ml = te(),
      ...
      ti = class extends gl.ManagerTool {
        ...
        register(e, t, i = "after", n) {
          ...
          if (
            (typeof e == "string"
              ? (s = this.getGlobal("document").querySelector(ri[e]))
              : (s = e),
            !s)
          )
            return !1;
    ...
    var Sl = ["key_copyCitation", "key_copyBibliography"],
      ...
      Cl = [
        ...
        },
        {
          ...
          key: "W",
          callback: () => {
            let r = z.BasicTool.getZotero().getMainWindow().Zotero_Tabs;
        ...
        },
        {
          ...
          key: "T",
          callback: () => {
            z.BasicTool.getZotero().getMainWindow().Zotero_Tabs.undoClose();
          },
        },
        {
          id: "selectNextTab",
          ...
          key: "Tab",
          callback: () => {
            z.BasicTool.getZotero().getMainWindow().Zotero_Tabs.selectPrev();
          },
        },
        {
          ...
          key: "Tab",
          callback: () => {
            z.BasicTool.getZotero().getMainWindow().Zotero_Tabs.selectNext();
          },
        },
        {
          id: "selectTab1",
          ...
          key: "1",
          callback: () => {
            z.BasicTool.getZotero().getMainWindow().Zotero_Tabs.jump(0);
          },
        },
        {
          id: "selectTab2",
          ...
          key: "2",
          callback: () => {
            z.BasicTool.getZotero().getMainWindow().Zotero_Tabs.jump(1);
          },
        },
        {
          id: "selectTab3",
          ...
          key: "3",
          callback: () => {
            z.BasicTool.getZotero().getMainWindow().Zotero_Tabs.jump(2);
          },
        },
        {
          id: "selectTab4",
          ...
          key: "4",
          callback: () => {
            z.BasicTool.getZotero().getMainWindow().Zotero_Tabs.jump(3);
          },
        },
        {
          id: "selectTab5",
          ...
          key: "5",
          callback: () => {
            z.BasicTool.getZotero().getMainWindow().Zotero_Tabs.jump(4);
          },
        },
        {
          id: "selectTab6",
          ...
          key: "6",
          callback: () => {
            z.BasicTool.getZotero().getMainWindow().Zotero_Tabs.jump(5);
          },
        },
        {
          id: "selectTab7",
          ...
          key: "7",
          callback: () => {
            z.BasicTool.getZotero().getMainWindow().Zotero_Tabs.jump(6);
          },
        },
        {
          id: "selectTab8",
          ...
          key: "8",
          callback: () => {
            z.BasicTool.getZotero().getMainWindow().Zotero_Tabs.jump(7);
          },
        },
        {
          id: "selectTabLast",
          ...
          key: "9",
          callback: () => {
            z.BasicTool.getZotero().getMainWindow().Zotero_Tabs.selectLast();
          },
        },
      ];
  });
...
`;
  ...
  var Yn = v((Fe) => {
    ...
    var Nl = x(),
      ...
      hi = class extends Nl.ManagerTool {
        ...
        initializeGlobal() {
          if (
            ((this.globalCache = ql.default.getInstance().readerInstance),
            !this.globalCache._ready)
          ) {
            this.globalCache._ready = !0;
            let e = this.getGlobal("Zotero"),
        ...
        constructor(e, t, i = "default") {
          super(),
            ...
            i === "default"
              ...
              : i === "parser"
                ? (this.hooks = Vl)
                : (this.hooks = Object.assign(Object.assign({}, ts), i)),
            (this.innerObj = {});
        }
        asObject() {
      ...
      Qt = class extends oe.BasicTool {
        constructor() {
          super(),
            ...
            (this.LibraryTabPanel = new Ql.LibraryTabPanelManager(this)),
            (this.ReaderTabPanel = new $l.ReaderTabPanelManager(this)),
            (this.ReaderInstance = new oc.ReaderInstanceManager(this)),
            (this.Menu = new Xl.MenuManager(this)),
            (this.PreferencePane = new Yl.PreferencePaneManager(this)),
            (this.Shortcut = new ec.ShortcutManager(this)),
            (this.Clipboard = (0, oe.makeHelperTool)(tc.ClipboardHelper, this)),
            (this.FilePicker = (0, oe.makeHelperTool)(
              rc.FilePickerHelper,
              this,
            )),
            (this.Patch = (0, oe.makeHelperTool)(dc.PatchHelper, this)),
            ...
            (this.Dialog = (0, oe.makeHelperTool)(sc.DialogHelper, this)),
  ...
  var F = v((V) => {
    ...
    vi(/x/) &&
      (V.isFunction = vi =
        function (r) {
          return typeof r == "function" && yi.call(r) === "[object Function]";
        });
    V.isFunction = vi;
    var as =
      Array.isArray ||
      function (r) {
        return r && typeof r == "object" ? yi.call(r) === "[object Array]" : !1;
      };
    V.isArray = as;
    function gc(r, e) {
    ...
    Xt.default = function (r) {
      r.registerHelper("blockHelperMissing", function (e, t) {
        ...
        if (t.data && t.ids) {
          ...
          (s.contextPath = wi.appendContextPath(t.data.contextPath, t.name)),
            (t = { data: s });
        }
        return n(e, t);
      });
  ...
  var hs = v((Yt, ds) => {
    ...
    Yt.default = function (r) {
      r.registerHelper("each", function (e, t) {
        ...
        t.data &&
          t.ids &&
          (c = at.appendContextPath(t.data.contextPath, t.ids[0]) + "."),
          at.isFunction(e) && (e = e.call(this)),
          t.data && (a = at.createFrame(t.data));
        function l(p, g, b) {
          a &&
            ((a.key = p),
            (a.index = g),
            ...
            (o =
              ...
              i(e[p], {
                data: a,
                blockParams: at.blockParams([e[p], p], [c + p, null]),
              }));
        }
    ...
    tr.default = function (r) {
      r.registerHelper("if", function (e, t) {
        ...
        r.registerHelper("unless", function (e, t) {
          if (arguments.length != 2)
            throw new gs.default("#unless requires exactly one argument");
  ...
  var xs = v((nr, Ss) => {
    ...
    nr.default = function (r) {
      r.registerHelper("with", function (e, t) {
        ...
        var i = t.fn;
        if (lt.isEmpty(e)) return t.inverse(this);
        var n = t.data;
        return (
          t.data &&
            t.ids &&
            ((n = lt.createFrame(t.data)),
            (n.contextPath = lt.appendContextPath(
              t.data.contextPath,
              t.ids[0],
            ))),
          i(e, {
            data: n,
            blockParams: lt.blockParams([e], [n && n.contextPath]),
          })
        );
      });
    };
  ...
  var Pi = v((ct) => {
    "use strict";
    ct.__esModule = !0;
    ct.createProtoAccessControl = ou;
    ct.resultIsAllowed = au;
    ct.resetLoggedProperties = cu;
    function iu(r) {
      return r && r.__esModule ? r : { default: r };
    }
    var Es = Is(),
    ...
    function ou(r) {
      ...
      return (
        ...
        {
          properties: {
            whitelist: Es.createNewLookupObject(t, r.allowedProtoProperties),
            defaultValue: r.allowProtoPropertiesByDefault,
          },
          methods: {
            whitelist: Es.createNewLookupObject(e, r.allowedProtoMethods),
    ...
    Ei.prototype = {
      ...
      registerHelper: function (e, t) {
        if (xe.toString.call(e) === Ii) {
          if (t)
            throw new Ti.default("Arg not supported with multiple helpers");
      ...
      registerDecorator: function (e, t) {
        if (xe.toString.call(e) === Ii) {
          if (t)
            throw new Ti.default("Arg not supported with multiple decorators");
        ...
        (s._setup = function (o) {
          if (o.partial)
            ...
            Mu(a, n),
              ...
              (n.hooks = {}),
              (n.protoAccessControl = Hs.createProtoAccessControl(o));
  ...
  var Hi = v((mr, Us) => {
    ...
    var js = {
      helpers: {
        ...
        simpleId: function (e) {
          return e.parts.length === 1 && !js.helpers.scopedId(e) && !e.depth;
        },
      },
    };
    mr.default = js;
    ...
    var Vu = (function () {
      var r = {
          ...
          parse: function (n) {
            ...
            for (var P, Z, T, C, ye, ne, he = {}, _e, G, et, ke; ; ) {
              if (
                ((T = o[o.length - 1]),
                this.defaultActions[T]
                  ? (C = this.defaultActions[T])
                  : ((P === null || typeof P > "u") && (P = E()),
                    (C = l[T] && l[T][P])),
              ...
              switch (C[0]) {
                ...
                case 2:
                  ...
                  G &&
                    ...
                    a.push(he.$),
                    c.push(he._$),
                    (et = l[o[o.length - 2]][o[o.length - 1]]),
                    o.push(et);
                  break;
                case 3:
                  return !0;
...
` +
  ...
  var Bi = v((yr, Ys) => {
    ...
    br.prototype = {
      ...
      accept: function (e) {
        if (e) {
          if (!this[e.type]) throw new zi.default("Unknown type: " + e.type, e);
  ...
  var ro = v((Q) => {
    ...
    function Ki(r, e) {
      if (((e = e.path ? e.path.original : e), r.path.original !== e)) {
        ...
        throw new Vi.default(r.path.original + " doesn't match " + e, t);
      }
    }
    function Qu(r, e) {
      (this.source = r),
    ...
    function id(r, e, t, i, n, s) {
      ...
      var a = void 0,
        c = void 0;
      if (t) {
        if (o) throw new Vi.default("Unexpected inverse block on decorator", t);
  ...
  var co = v((mt) => {
    ...
    Gi.prototype = {
      ...
      accept: function (e) {
        if (!this[e.type]) throw new pt.default("Unknown type: " + e.type, e);
      ...
      PathExpression: function (e) {
        ...
        var t = e.parts[0],
          i = ht.default.helpers.scopedId(e),
      ...
      classifySexpr: function (e) {
        var t = ht.default.helpers.simpleId(e.path),
          i = t && !!this.blockParamIndex(e.path.parts[0]),
          n = !i && ht.default.helpers.helperExpression(e),
          s = !i && (n || t);
        if (s && !n) {
    ...
    function lo(r, e) {
      if (r === e) return !0;
      if (ft.isArray(r) && ft.isArray(e) && r.length === e.length) {
        for (var t = 0; t < r.length; t++) if (!lo(r[t], e[t])) return !1;
        return !0;
      }
    }
    function oo(r) {
  ...
  var Ji = v((Ui) => {
    ...
    Ui.encode = function (e) {
      var t = "",
        i,
        n = yd(e);
      do (i = n & mo), (n >>>= ji), n > 0 && (i |= go), (t += po.encode(i));
      while (n > 0);
      return t;
    };
  ...
  var je = v((B) => {
    ...
    function Qi(r) {
      ...
      for (
        var i = B.isAbsolute(e), n = e.split(/\/+/), s, o = 0, a = n.length - 1;
        a >= 0;
        a--
      )
        (s = n[a]),
    ...
    function vo(r, e) {
      ...
      var n = e.charAt(0) === "/" ? e : Qi(r.replace(/\/+$/, "") + "/" + e);
    ...
    $.prototype._serializeMappings = function () {
      for (
        ...
        if (((l = h[f]), (c = ""), l.generatedLine !== t))
          ...
          if (!N.compareByGeneratedPositionsInflated(l, h[f - 1])) continue;
          c += ",";
        }
        (c += bt.encode(l.generatedColumn - e)),
          (e = l.generatedColumn),
          l.source != null &&
            ((u = this._sources.indexOf(l.source)),
            (c += bt.encode(u - o)),
            (o = u),
            (c += bt.encode(l.originalLine - 1 - n)),
            (n = l.originalLine - 1),
            (c += bt.encode(l.originalColumn - i)),
            (i = l.originalColumn),
            l.name != null &&
  ...
  var Mo = v((xr) => {
    ...
    A.prototype.eachMapping = function (e, t, i) {
      var n = t || null,
        s = i || A.GENERATED_ORDER,
        o;
      switch (s) {
    ...
    q.fromSourceMap = function (e, t) {
      ...
      return vt(i.__originalMappings, y.compareByOriginalPositions), i;
    };
    ...
    q.prototype._parseMappings = function (e, t) {
      for (
        ...
        if (e.charAt(d) === ";") i++, d++, (n = 0);
          ...
          if (((b = e.slice(d, S)), (m = u[b]), m)) d += b.length;
            ...
            for (m = []; d < S; )
              Nd.decode(e, d, h), (E = h.value), (d = h.rest), m.push(E);
            if (m.length === 2)
      ...
      vt(p, y.compareByGeneratedPositionsDeflated),
        (this.__generatedMappings = p),
        vt(f, y.compareByOriginalPositions),
    ...
    q.prototype.originalPositionFor = function (e) {
      var t = {
        ...
        i = this._findMapping(
          ...
          y.getArg(e, "bias", A.GREATEST_LOWER_BOUND),
        );
      if (i >= 0) {
      ...
      this._sections = n.map(function (o) {
        ...
        return (
          (s = a),
          {
            ...
            consumer: new A(y.getArg(o, "map"), e),
          }
        );
      });
    }
    ee.prototype = Object.create(A.prototype);
    ee.prototype.constructor = A;
    ...
    ee.prototype._parseMappings = function (e, t) {
      ...
      vt(this.__generatedMappings, y.compareByGeneratedPositionsDeflated),
        vt(this.__originalMappings, y.compareByOriginalPositions);
    };
    ...
    K.fromStringWithSourceMap = function (e, t, i) {
      ...
      return (
        ...
        t.sources.forEach(function (h) {
          ...
          f != null &&
            (i != null && (h = Cr.join(i, h)), n.setSourceContent(h, f));
        }),
        n
      );
      function u(h, f) {
  ...
  var zo = v((Pr, Ho) => {
    ...
    Te ||
      ...
      (Te.prototype = {
        ...
        prepend: function (e) {
          an.isArray(e) && (e = e.join("")), (this.src = e + this.src);
        },
    ...
    $e.prototype = {
      ...
      compile: function (e, t, i, n) {
        ...
        if (
          ...
          throw new ln.default("Compile completed with content left on stack");
...
`),
    ...
    `.trim();
      ...
      popStack: function (e) {
        ...
        if (!t) {
          if (!this.stackSlot) throw new ln.default("Invalid stack pop");
          this.stackSlot--;
        }
        return i;
      },
  ...
  var H = JSON.parse(String(Y("statuses"))),
  ...
  function Hr() {
    ztoolkit.log("Fn: loadPrefs"),
      (H = JSON.parse(String(Y("statuses")))),
      H.map((r) => ((r.keystroke = st.fromString(r.keyboardShortcut)), r)),
      (Ne = String(Y("status-tag-prefix"))),
      (se = Ne + String(Y("reason-tag-prefix")));
  }
  function En(r) {
  ...
  function Mn(r) {
    let e = H.find((t) => t.default == !0);
    for (let t of H) r.hasTag(t.tag) && (e = t);
    return e;
  }
  function zr(r) {
    return r
  ...
  function bi(r) {
    ...
    function gn(k, w, O) {
      ...
      r.fetch(
        ...
        function (M) {
          f === j &&
            M &&
            ((c = M), (l = k), (h = c.length < 1 || o ? void 0 : c[0]), ne());
        },
        w,
        O,
      );
    ...
    function bn(k) {
      if (r.keyup) {
        r.keyup({ event: k, fetch: () => tt(0) });
        return;
      }
      !T() && k.key === "ArrowDown" && tt(0);
    }
    function vn(k) {
      r.click && r.click({ event: k, fetch: () => tt(2) });
    }
    function yn() {
      setTimeout(() => {
        e.activeElement !== m && C();
    ...
    function va() {
      m.removeEventListener("focus", mn),
        ...
        e.removeEventListener("scroll", et, !0),
    ...
    return (
      ...
      e.addEventListener("scroll", et, !0),
      { destroy: va, fetch: ba }
    );
  }
  function ss(r, e) {
...
`);
  ...
  async function $o() {
    ...
    (e.textContent = R("reason-dialog-text")), r.appendChild(e);
    ...
    let l = Ye("reason-modal", R("reason-dialog-title"), r);
  ...
  function Yo() {
    ztoolkit.getGlobal("document").generateReport = async () => {
      ...
      if (r.length == 0 || !_t) return;
      let e = 0;
      _t.innerHTML = "";
      for (let t of H) {
        let i = t.label != "" ? t.label : R("status-blank-label"),
          s = r.filter((o) => o.hasTag(t.tag)).length;
        (_t.innerHTML += `
            <tr>
                <td>${i}</td>
  ...
  async function ea() {
            ...
            <table class="table">
                <thead>
                    <tr class="border-bottom">
                        <th>${R("report-dialog-table-status")}</th>
                        <th>${R("report-dialog-table-count")}</th>
                    </tr>
                </thead>
                <tbody>
                </tbody>
    ...
    r.append(e), (_t = r.querySelector("tbody"));
    let t = Ye("report-modal", R("report-dialog-title"), r);
    ...
    static registerExtraColumnWithBindings() {
      ...
      ztoolkit.Menu.register("item", { tag: "menuseparator" }),
        ztoolkit.Menu.register("item", {
          tag: "menu",
          label: R("context-menu-status"),
          children: n,
        }),
        ztoolkit.getGlobal("document").addEventListener("keydown", (s) => {
  ...
  async function rh(r) {
    return new Promise((e, t) => {
      let i = [
        {
          dataKey: "label",
          label: R("prefs-table-label"),
          fixedWidth: !0,
          width: 100,
        },
        {
          dataKey: "name",
          label: R("prefs-table-name"),
          fixedWidth: !0,
          width: 100,
        },
        {
          dataKey: "tag",
          label: R("prefs-table-tag"),
          fixedWidth: !0,
          width: 100,
        },
        { dataKey: "color", label: R("prefs-table-color") },
        { dataKey: "askForReason", label: R("prefs-table-askforreason") },
        { dataKey: "default", label: R("prefs-table-default") },
        {
          dataKey: "keyboardShortcut",
          label: R("prefs-table-keyboardshortcut"),
        },
      ];
      ia = new ztoolkit.VirtualizedTable(r)
        ...
        .setProp("getRowCount", () => H.length || 0)
        .setProp("getRowData", (n) => H[n] || {})
        .setProp("getRowString", (n) => H[n].title || "")
  ...
  function nh() {
    ztoolkit.log("Add Status"),
      (I.element.querySelector(".modal-title").textContent = "Add Status"),
